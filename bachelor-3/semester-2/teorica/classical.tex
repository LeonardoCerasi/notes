...
\begin{proposition}{Unitary equivalence}{dirac-spin-trans}
...
It can be shown that the Clifford algebra is invariant under the transformation in Prop. \ref{prop:dirac-spin-trans}, thus it defines an equivalent representation of the algebra.
  ...
  \begin{proof}
    ...
    \begin{equation*}
      ...
      \begin{pmatrix}
        m \\ 0
      \end{pmatrix}
      = \left( \tens{I}_2 \cosh \eta + \sigma_3 \sinh \eta \right)
      \begin{pmatrix}
        m \\ 0
      \end{pmatrix}
      =
      ...
      \end{pmatrix}
    \end{equation*}
    By Eqq. \ref{eq:1.40}-\ref{eq:1.41}, then:
    \begin{equation*}
      \begin{split}
      ...
      \end{split}
    \end{equation*}
    By the above Lorentz boost of four-momentum $ E + p^3 = e^\eta m $ and $ E - p^3 = e^{-\eta} m $, which yields the thesis.
  \end{proof}
\end{proposition}
...
\begin{equation}
  v^s(p) =
    \begin{pmatrix}
      \left[ \sqrt{E + p^3}\, \frac{1 - \sigma^3}{2} + \sqrt{E - p^3}\, \frac{1 + \sigma^3}{2} \right] \eta^s \\
      - \left[ \sqrt{E + p^3}\, \frac{1 + \sigma^3}{2} + \sqrt{E - p^3}\, \frac{1 - \sigma^3}{2} \right] \eta^s \\
    \end{pmatrix}
  \label{eq:1.90}
\end{equation}
