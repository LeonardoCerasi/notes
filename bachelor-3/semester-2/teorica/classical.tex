...
If translations are added to the Lorentz group, the result is the \textit{Poincaré group} $ \pog $. Given a translation $ x^\mu \mapsto x^\mu + a^\mu $, the associated group element can be written as:
\begin{equation}
  T = e^{-i a_\mu P^\mu}
  \label{eq:1.49}
\end{equation}
