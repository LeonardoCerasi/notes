...
\begin{proposition}{}{lorentz-algebra}
  The Lorentz algebra $ \lora $ can be decomposed as $ \mathfrak{su}(2) \oplus \mathfrak{su}(2) $.
  ...
  \begin{proof}
    ...
    \end{equation}
    The Lie algebra then becomes $ [\ve{J}_{\pm}^i, \ve{J}_{\pm}^j] = i \epsilon^{ijk} \ve{J}_{\pm}^k $ and $ [\ve{J}_{\pm}^i, \ve{J}_{\mp}^j] = 0 $: these are two commuting $ \mathfrak{su}(2) $ algebras, thus proving the thesis.
  \end{proof}
\end{proposition}
...
\paragraph{Adjoint representation of $ \lorg $}
