...
\NewTcbTheorem[number within=section]{definition}{Definizione}%
...
\newtcbtheorem[number within=tcb@cnt@theorem]{corollary}{Corollario}%
...
\newtcbtheorem[number within=lemma]{lemcorollary}{Corollario}%
...
\newtcbtheorem[number within=proposition]{propcorollary}{Corollario}%
...
\newcommand{\GL}[2]{\mathrm{GL}(#1)}
\newcommand{\SL}[2]{\mathrm{SL}(#1)}
