...
\section{Atoms in a magnetic field}
...
\paragraph{Atoms with $ \bs{S \neq 0} $}

We can distinguish between between two cases: the magnetic field dominates or the spin-orbit coupling dominates, which are respectively known as \bctxt{Paschen--Back effect} and \bctxt{anomalous Zeeman effect} (as it requires a quantistic description, contrary to the normal Zeeman effect).
