...
\section{Multiple valence electrons}

In multi-electron atoms, the potential is no longer spherically-symmetric. The corrections with respect to the unperturbed spherically-symmetric case are determined by the total angular momenta:
\begin{equation}
...
\end{equation*}
This is \bctxt{Landé's spacing law}: note that this is symmetric under $ L \leftrightarrow S $.
