...
\footnotetext{Acoustic bands can be studied using neutrons, since their dispersion relations is:
\begin{equation*}
  E = \frac{\hbar^2 k^2}{2m_n}
\end{equation*}
which allows for an intersection even with acoustic bands, which have lower frequencies than optical bands.}
