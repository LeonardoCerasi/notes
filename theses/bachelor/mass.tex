...
\begin{equation*}
  \sum_{i \in \fsm{n}{m}} \left[ \caf \left( \frac{1}{\de} - \frac{1}{\kappa_i} \log \frac{1 - \kappa_i}{1 + \kappa_i} - 2 \lmx \right) - \caf \left( \frac{1}{\de} + \frac{1}{2} \log \frac{m_\mq^2}{\mu^2} - 2 \right) \right] \equiv \finm{i}
\end{equation*}
...
\end{equation}
We now focus on the colour-correlated summation, in particular:
\begin{equation*}
  \begin{split}
    \sum_{i \neq j \in \fsp{n}{m}} (\cc) \left( \ci{i,j} - \finci{i,j} \right)
    & = \sum_{i \in \fsp{n}{m}} \tco_i \cdot \bigg[ \sum_{j \in \fsp{n}{m}} \tco_j \left( \ci{i,j} - \finci{i,j} \right) - \tco_i \left( \ci{i,i} - \finci{i,j} \right) \bigg] \\
    & = \sum_{i \in \prt{n}{m}} \tco_i \cdot \bigg[ \sum_{j \in \prt{n}{m}} \tco_j \frac{\leg_i + \leg_j}{\de} + \frac{L_i}{\de} \sum_{j \in \fsm{n}{m}} \tco_j - \tco_i \frac{\leg_i}{\de} \bigg] \\
    & \qquad \qquad \qquad \qquad \qquad \qquad \quad + \sum_{i \in \fsm{n}{m}} \tco_i \cdot \bigg[ \sum_{j \in \prt{n}{m}} \tco_j \frac{\leg_j}{\de} \bigg] \\
    & = \sum_{i \in \fsp{n}{m}} \tco_i \cdot \sum_{j \in \prt{n}{m}} \tco_j \frac{L_j}{\de} + \sum_{i \in \prt{n}{m}} \frac{\leg_i}{\de} \tco_i \cdot \sum_{j \in \fsp{n}{m}} \tco_j - \sum_{i \in \prt{n}{m}} \tco_i^2 \frac{\leg_i}{\de}
  \end{split}
\end{equation*}
