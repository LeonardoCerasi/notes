...
Then, contracting \eref{eq:diag-norm} with $ \delta^{ab} $ (with $ a,b = 1,\dots, n_c^2 - 1 $, as they label the basis of $ \mathfrak{su}(n_c) $):
\begin{equation*}
  C_2(\mathtt{n}) n_c = \ttr (n_c^2 - 1)
\end{equation*}
...
\begin{equation*}
  C_2(\mathtt{g}) (n_c^2 - 1) = 2\ttr \frac{n_c^2 - 1}{n_c} n_c^2
\end{equation*}
