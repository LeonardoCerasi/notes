...
\end{equation}
\begin{equation}
  \dd\pcs_{a,b}^\text{C}(p_1 , p_2) \defeq \frac{\rcr}{2\pi} \frac{1}{\de} \sum_c \int_0^1 \frac{\dd z}{z} \left[ \ap_{f_a,f_c}(z) \dd\pcs_{c,b}^{(0)}(z p_1 , p_2) + \ap_{f_b,f_c}(z) \dd\pcs_{a,c}^{(0)}(p_1 , z p_2) \right]
  \label{eq:pdf-cs}
\end{equation}
...
\begin{equation}
  \rop_{i,j}(z) = \delta_{i,j} \delta(1-z) + \frac{\rcr}{2\pi} \frac{1}{\de} \ap_{f_i , f_j}(z) + \smo(\rc^2)
  \label{eq:z-op-def}
\end{equation}
...
\begin{equation*}
  \begin{split}
    ...
    & = \sum_{a,c} \int_{[0,1]^2} \frac{\dd y_1}{y_1} \frac{\dd y_2}{y_2} \left[ \delta_{a,c} \delta(1 - y_1) + \frac{\rcr}{2\pi} \frac{1}{\de} \ap_{f_a , f_c}(y_1) + \smo(\rc^2) \right] \pdfr{c}{h}(y_2) \dd\pcs_a(y_1 y_2 P) \\
    & = \sum_a \int_0^1 \frac{\dd \xi}{\xi} \left[ \pdfr{a}{h}(\xi) \dd\pcs_a(\xi P) + \frac{\rcr}{2\pi} \frac{1}{\de} \sum_{c} \int_0^1 \frac{\dd z}{z} \ap_{f_a , f_c}(z) \pdfr{c}{h}(\xi) \dd\pcs_a(z \xi P) + \smo(\rc^2) \right]
  \end{split}
\end{equation*}
