...
\begin{equation}
  ...
  \label{eq:pdf-cs}
\end{equation}
In \eref{eq:real-cs} $ \fs $ contains $ m+1 $ partons, while in \eref{eq:virt-cs} it only contains $ m $ partons. The Altarelli-Parisi splitting kernels are listed in APPENDIX, and proof of \eref{eq:pdf-cs} is provided in SECTION.
