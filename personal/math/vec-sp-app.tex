...
\begin{theorem}{Rouché--Capelli}{rouche-capelli}
...
In this subsection, we always consider $ V $ to be a $ \R $-vector space of dimension $ \dk V = n \in \N $.

\begin{definition}{Positive-definite bilinear form}{}
  A symmetric bilinear form $ b : V \times V \ra V $ is \bcdef{positive-definite} if $ b(\ve{v} , \ve{v}) \ge 0 \,\,\forall \ve{v} \in V $ and $ b(\ve{v} , \ve{v}) = 0 \iff \ve{v} = \ve{0} $.
\end{definition}
