...
The Feynman propagator in position and momentum space is denoted by $ \fpr(x,y) \equiv \fpr(x - y) $ and $ \fprp(p) $, the Dirac propagator by $ \dpr(x,y) \equiv \dpr(x - y) $ and $ \dprp(p) $, and the photon propagator by $ \gpr(x,y) \equiv \gpr(x - y) $ and $ \gprp(p) $.
