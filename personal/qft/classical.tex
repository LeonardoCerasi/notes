...
\begin{equation}
  \begin{gathered}
    ...
    \rho_{(j_-,j_+)}(K^i) = -i \left[ J^i_{(j_+)} \otimes \mt{I}_{(2j_ + 1)} - \mt{I}_{(2j_+ + 1)} \otimes J^i_{(j_-)} \right]
  \end{gathered}
...
\end{equation}
By \eref{eq:sun-trace} and \pref{prop:lorentz-algebra}, $ \sla{2,\C} = \{\mt{X} \in \C^{2 \times 2} : \tr \mt{X} = 0\} $ and an $ \R $-basis is $ \{\frac{\bs{\sigma}}{2},i\frac{\bs{\sigma}}{2}\} $, then:
\begin{equation*}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \tensor{\left[ \mt{I}_4 - \frac{i}{2} \omega_{\rho \sigma} J^{\rho \sigma} \right]}{^\mu_\nu} \gamma^\nu = \left[ \mt{I}_4 + \frac{i}{2} \omega_{\rho \sigma} \sigma^{\rho \sigma} \right] \gamma^\mu \left[ \mt{I}_4 - \frac{i}{2} \omega_{\rho \sigma} \sigma^{\rho \sigma} \right]
    \end{equation*}
    which becomes:
    \begin{equation*}
...
\begin{equation*}
  \delta_0 \Psi \equiv \Psi'(x) - \Psi(x) = \Psi'(x') - \delta x^\rho \pa_\rho \Psi(x) - \Psi(x) = \left( \Lambda_\text{D} - \mt{I}_4 \right) \Psi(x) - \frac{i}{2} \omega_{\mu \nu} L^{\mu \nu} \Psi(x)
\end{equation*}
...
\begin{equation*}
  \begin{split}
    ...
    &= e^{-i (-\varepsilon_\mu) P^\mu} \phi'(x') - \phi(x) = \left( e^{i \varepsilon_\mu P^\mu} - \mt{I} \right) \phi(x) = i \varepsilon_\mu P^\mu \phi(x)
  \end{split}
\end{equation*}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \lag_\text{D} = \Psi'^\dagger \mt{U} \gamma^0 (i \gamma^\mu \pa_\mu - m) \mt{U}^\dagger \Psi' = \Psi'^\dagger \mt{U} \gamma^0 \mt{U}^\dagger (i \mt{U} \gamma^\mu \mt{U}^\dagger \pa_\mu - m) \Psi' = \bar{\Psi}' (i \gamma'^\mu \pa_\mu - m) \Psi'
    \end{equation*}
