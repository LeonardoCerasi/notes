...
\end{align*}
where $ \gamma^5 \defeq \img \gamma^0 \gamma^1 \gamma^2 \gamma^3 $ is an additional gamma matrix. Note that this matrix is not in the basis of $ \dira $. It has the following properties:
\begin{equation*}
  (\gamma^5)\dg = \gamma^5
  \qquad
  (\gamma^5)^2 = \mt{I}_4
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \tensor{\left[ \mt{I}_4 - \frac{\img}{2} \omega_{\rho \sigma} J^{\rho \sigma} \right]}{^\mu_\nu} \gamma^\nu = \left[ \mt{I}_4 + \frac{\img}{2} \omega_{\rho \sigma} \sigma^{\rho \sigma} \right] \gamma^\mu \left[ \mt{I}_4 - \frac{\img}{2} \omega_{\rho \sigma} \sigma^{\rho \sigma} \right]
    \end{equation*}
    which becomes:
    \begin{equation*}
