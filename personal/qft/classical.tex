...
\footnotetext{To be precise, this is a representation equivalent to $ \ve{\left( \frac{1}{2},0 \right)} \otimes \ve{\left( 0,\frac{1}{2} \right)} $, which would act on $ [\psi \otimes \xi]_{(ij)} = \psi_i \xi_j $.}
