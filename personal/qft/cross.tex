...
\end{equation}
From a quantum point of view, $ N $ is the probability of the transition $ \ket{\text{in}} \rightarrow \ket{\text{out}} $ between the initial and final states, thus:
\begin{equation*}
  \dd \sigma = \frac{1}{j \Delta t} \abs{\braket{\text{out}(f) | \text{in}}}^2 \dd f
\end{equation*}
