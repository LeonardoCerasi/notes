...
\begin{equation*}
  \tilde{G}^{(k,n)}(\{p_i\} , \alpha , m , \Lambda) = \braket{0 | \tempord\{A(p_1) \dots A(p_k) , \Psi{p_{k + 1}} \dots \Psi_{p_{k + n}} \} | 0}
\end{equation*}
...
\begin{equation}
  \left[ \frac{\pa}{\pa \log \mu^2} - \beta(\alpha_\text{r}) \frac{\pa}{\pa \alpha_\text{r}} - \beta_m(\alpha_\text{r} , m_\text{r}) \frac{\pa}{\pa m_\text{r}} + k \gamma_\gamma(\alpha_\text{r}) + k \gamma_e(\alpha_\text{r} , m_\text{r}) \right] \tilde{G}_\text{r}^{(k,n)}(\{p_i\} , \alpha_\text{r} , m_\text{r} , \mu)
\end{equation}
