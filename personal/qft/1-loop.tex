...
\end{equation*}
Since the divergent part of the vacuum polarization is independent of the energy scale (\eref{eq:vacuum-polarization-div}), this expression is correctly finite, as it is to be expected from physically observable quantities.
