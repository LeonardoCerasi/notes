...
\begin{observation}{Renormalizablity of QED}{}
  Consider the QED Lagrangian \eref{eq:qed-lagrangian} in $ d \in \R^+ $ dimensions. Then, imposing $ [\lag_\text{QED}] = d $ and $ [m] = [\slashed{\pa}] = 1 $, it is trivial to see that:
  \begin{equation}
    [A_\mu] = \frac{d - 2}{2}
    \qquad
    [\Psi] = \frac{d - 1}{2}
...
\begin{equation*}
    ...
    \ \sim \log \Lambda
\end{equation*}
These are respectively are corrections to the photon propagator (collectively denoted as vacuum polarization), to the electron propagator (denoted as electron self-energy) and to the electron-photon interaction vertex.
...
On the other hand, the integral in the magnetic form factor is trivial\footnotemark on the light-cone $ q^2 = 0 $, and the resulting expression $ F_2(0) = \frac{\alpha}{2\pi} $ determines the first-order correction to the Landé factor:
\begin{equation*}
