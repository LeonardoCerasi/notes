...
\begin{proofbox}
  \begin{proof}
    $ \braket{\ve{p}_1 | \ve{p}_2} = \sqrt{2E_{\ve{p}_1}} \sqrt{2E_{\ve{p}_2}} \braket{0 | a_{\ve{p}_1} a_{\ve{p}_2}^\dagger | 0} $, but $ \braket{0 | a_{\ve{p}_1} a_{\ve{p}_2}\dg | 0} = \braket{0 | [a_{\ve{p}_1} , a_{\ve{p}_2}^\dagger] | 0} $, hence $ \braket{\ve{p}_1 | \ve{p}_2} = 2E_{\ve{p}_1} (2\pi)^3 \delta^{(3)}(\ve{p}_1 - \ve{p}_2) $ by \eref{eq:scalar-quant-op-comm}.
  \end{proof}
\end{proofbox}
