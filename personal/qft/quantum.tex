...
\begin{equation}
  [\phi(t,\ve{x}) , \Pi(t,\ve{y})] = \img \delta^{(3)}(\ve{x} - \ve{y})
...
\begin{equation}
  \phi(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \left[ a_\ve{p} e^{-\img p_\mu x^\mu} + a_\ve{p}^\dagger e^{\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p}}
...
\begin{proofbox}
  \begin{proof}
    By \eref{eq:scalar-quant-op-comm}, $ \braket{\ve{p}_1 | \ve{p}_2} = \sqrt{2E_{\ve{p}_1}} \sqrt{2E_{\ve{p}_2}} \braket{0 | a_{\ve{p}_1} a_{\ve{p}_2}^\dagger | 0} $, but $ \braket{0 | a_{\ve{p}_1} a_{\ve{p}_2}\dg | 0} = \braket{0 | [a_{\ve{p}_1} , a_{\ve{p}_2}^\dagger] | 0} $, hence $ \braket{\ve{p}_1 | \ve{p}_2} = 2E_{\ve{p}_1} (2\pi)^3 \delta^{(3)}(\ve{p}_1 - \ve{p}_2) $.
  \end{proof}
\end{proofbox}
...
\begin{proofbox}
  \begin{proof}
    ...
    \end{equation*}
    Clearly, then, $ E_\ve{p} \delta^{(3)}(\ve{p} - \ve{q}) $ is Lorentz invariant.
  \end{proof}
\end{proofbox}
  ...
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        ...
        &= -\img \int \frac{\dd^3 p}{(2\pi)^3} \sqrt{\frac{E_\ve{p}}{2}} \left[ a_\ve{p} e^{-\img p_\mu x^\mu} - a_\ve{p}^\dagger e^{\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p}} \\
        &= -\img \int \frac{\dd^3 p}{(2\pi)^3} \sqrt{\frac{E_\ve{p}}{2}} \left[ a_\ve{p} e^{-\img E_\ve{p} t} - a_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] e^{i \ve{p} \cdot \ve{x}}
      \end{split}
    \end{equation*}
    \begin{equation*}
      \bs{\nabla} \phi(t,\ve{x}) = \img \int \frac{\dd^3 p}{(2\pi)^3} \frac{\ve{p}}{\sqrt{2E_\ve{p}}} \left[ a_\ve{p} e^{-\img E_\ve{p} t} + a_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] e^{\img \ve{p} \cdot \ve{x}}
    \end{equation*}
    Inserting these expressions in \eref{eq:scalar-field-haml}:
    \begin{equation*}
      \begin{split}
        \ham
        &= \frac{1}{2} \int \frac{\dd^3 p}{(2\pi)^3} \int \frac{\dd^3 q}{(2\pi)^3} \bigg\{ - \frac{\sqrt{E_\ve{p} E_\ve{q}}}{2} \left[ a_\ve{p} e^{-\img E_\ve{p} t} - a_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] \left[ a_\ve{q} e^{-\img E_\ve{q} t} - a_{-\ve{q}}^\dagger e^{\img E_{\ve{q}} t} \right] + \\
        & \qquad + \frac{- \ve{p} \cdot \ve{q} + m^2}{2\sqrt{E_\ve{p} E_\ve{q}}} \left[ a_\ve{p} e^{-\img E_\ve{p} t} + a_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] \left[ a_\ve{q} e^{-\img E_\ve{q} t} + a_{-\ve{q}}^\dagger e^{\img E_\ve{q} t} \right] \bigg\} e^{\img (\ve{p} + \ve{q}) \cdot \ve{x}}
      \end{split}
    \end{equation*}
    Recall the identity:
    \begin{equation}
      \int \frac{\dd^3x}{(2\pi)^3} e^{\img (\ve{p} - \ve{q}) \cdot \ve{x}} = \delta^{(3)}(\ve{p} - \ve{q})
    ...
    \begin{equation*}
      \begin{split}
        H
        &= \int \dd^3x\, \ham \\
        &= \frac{1}{2} \int \frac{\dd^3 p}{(2\pi)^3} \int \dd^3 q \bigg\{ - \frac{\sqrt{E_\ve{p} E_\ve{q}}}{2} \left[ a_\ve{p} e^{-\img E_\ve{p} t} - a_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] \left[ a_\ve{q} e^{-\img E_\ve{q} t} - a_{-\ve{q}}^\dagger e^{\img E_\ve{q} t} \right] + \\
        & \qquad + \frac{- \ve{p} \cdot \ve{q} + m^2}{2\sqrt{E_\ve{p} E_\ve{q}}} \left[ a_\ve{p} e^{-\img E_\ve{p} t} + a_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] \left[ a_\ve{q} e^{-\img E_\ve{q} t} + a_{-\ve{q}}^\dagger e^{\img E_\ve{q} t} \right] \bigg\} \delta^{(3)}(\ve{p} + \ve{q}) \\
        &= \frac{1}{2} \int \frac{\dd^3 p}{(2\pi)^3} \bigg\{ - \frac{E_\ve{p}}{2} \left[ a_\ve{p} e^{-\img E_\ve{p} t} - a_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] \left[ a_{-\ve{p}} e^{-\img E_\ve{p} t} - a_\ve{p}^\dagger e^{\img E_\ve{p} t} \right] + \\
        & \qquad + \frac{\ve{p}^2 + m^2}{2E_\ve{p}} \left[ a_\ve{p} e^{-\img E_\ve{p} t} + a_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] \left[ a_{-\ve{p}} e^{-\img E_\ve{p} t} + a_\ve{p}^\dagger e^{\img E_\ve{p} t} \right] \bigg\} \\
        &= \frac{1}{2} \int \frac{\dd^3p}{(2\pi)^3} \frac{E_\ve{p}}{2} \bigg\{ - \left[ a_\ve{p} a_{-\ve{p}} e^{-2\img E_\ve{p} t} - a_{-\ve{p}}^\dagger a_{-\ve{p}} - a_\ve{p} a_\ve{p}^\dagger + a_{-\ve{p}}^\dagger a_\ve{p}^\dagger e^{2\img E_\ve{p} t} \right] \\
        & \qquad + \left[ a_\ve{p} a_{-\ve{p}} e^{-2\img E_\ve{p} t} + a_{-\ve{p}}^\dagger a_{-\ve{p}} + a_\ve{p} a_\ve{p}^\dagger + a_{-\ve{p}}^\dagger a_\ve{p}^\dagger e^{2\img E_\ve{p} t} \right] \bigg\} \\
...
\begin{equation}
  \braket{f,g} \defeq \img \int \dd^3x\, f^*(x) \smlra{\pa_0} g(x) = \img \int \dd^3x\, \left[ f^*(x) \pa_0 g(x) - \pa_0 f^*(x) g(x) \right] \equiv \img \int \dd^3x\, W_0[f^*,g](x)
\end{equation}
...
\begin{proposition}{Orthonormality of Fourier modes}{fourier-orthonorm}
  ...
  \begin{equation}
    f_\ve{p}(x) \equiv \frac{e^{-\img p_\mu x^\mu}}{\sqrt{(2\pi)^3 2 E_\ve{p}}}
    \qquad \qquad
    f^*_\ve{p}(x) \equiv \frac{e^{\img p_\mu x^\mu}}{\sqrt{(2\pi)^3 2 E_\ve{p}}}
  ...
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        ...
        & = \img \int \dd^3x\, f^*_\ve{p}(x) \smlra{\pa_0} f_\ve{q}(x) = \img \int \frac{\dd^3x}{(2\pi)^3 \sqrt{4 E_\ve{p} E_\ve{q}}} e^{\img (\ve{q} - \ve{p}) \cdot \ve{x}} \left( e^{\img E_\ve{p} t} \smlra{\pa}_0 e^{-\img E_\ve{q} t}  \right) \\
        & = \img \frac{\delta^{(3)}(\ve{q} - \ve{p})}{\sqrt{4 E_\ve{p} E_\ve{q}}} (-\img E_\ve{q} - \img E_\ve{p}) e^{\img (E_\ve{p} - E_\ve{q}) t} = \delta^{(3)}(\ve{p} - \ve{q})
      \end{split}
    \end{equation*}
...
\begin{theorem}{Ladder operators}{kg-ladder-op}
  ...
  \begin{equation}
    \sqrt{2E_\ve{p}} a_\ve{p} = \img \int \dd^3x\, e^{\img p_\mu x^\mu} \smlra{\pa_0} \phi(x)
    \qquad \qquad
    \sqrt{2E_\ve{p}} a_\ve{p}\dg = -\img \int \dd^3x\, e^{-\img p_\mu x^\mu} \smlra{\pa_0} \phi(x)
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      ...
      \quad \implies \quad
      \braket{f_\ve{p},\phi} = \frac{a_\ve{p}}{\sqrt{(2\pi)^3}}
    \end{equation*}
    by \pref{prop:fourier-orthonorm}. Then, inserting \eref{eq:fourier-modes} yields the thesis ($ a_\ve{p}\dg $ is analogous).
  \end{proof}
\end{proofbox}
...
\begin{equation}
  \phi(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \left[ a_\ve{p} e^{-\img p_\mu x^\mu} + b_\ve{p}^\dagger e^{\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p}}
\end{equation}
\begin{equation}
  \phi^\dagger(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \left[ a_\ve{p}^\dagger e^{\img p_\mu x^\mu} + b_\ve{p} e^{-\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p}}
\end{equation}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        Q_{\Un{1}}
        &= \img \int \dd^3x\, \phi^\dagger \smlra{\pa_0} \phi = \img \int \dd^3x \int \frac{\dd^3q}{(2\pi)^3 \sqrt{2E_\ve{q}}} \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \,\times \\
        & \quad \times \bigg\{ \left[ a_\ve{q}^\dagger e^{\img q_\mu x^\mu} + b_\ve{q} e^{-\img q_\mu x^\mu} \right] \pa_0 \left( a_\ve{p} e^{-\img p_\mu x^\mu} + b_\ve{p}^\dagger e^{\img p_\mu x^\mu} \right) + \\
        & \quad - \pa_0 \left( a_\ve{q}^\dagger e^{\img q_\mu x^\mu} + b_\ve{q} e^{-\img q_\mu x^\mu} \right) \left[ a_\ve{p} e^{-\img p_\mu x^\mu} + b_\ve{p}^\dagger e^{\img p_\mu x^\mu} \right] \bigg\} \\
        &= \int \dd^3x \int \frac{\dd^3q}{(2\pi)^3 \sqrt{2E_\ve{q}}} \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \,\times \\
        & \quad \times \bigg\{ E_\ve{p} \left[ a_\ve{q}^\dagger e^{\img q_\mu x^\mu} + b_\ve{q} e^{-\img q_\mu x^\mu} \right] \left[ a_\ve{p} e^{-\img p_\mu x^\mu} - b_\ve{p}^\dagger e^{\img p_\mu x^\mu} \right] + \\
        & \quad + E_\ve{q} \left[ a_\ve{q}^\dagger e^{\img q_\mu x^\mu} - b_\ve{q} e^{-\img q_\mu x^\mu} \right] \left[ a_\ve{p} e^{-\img p_\mu x^\mu} + b_\ve{p}^\dagger e^{\img p_\mu x^\mu} \right] \bigg\} \\
        &= \int \dd^3x \int \frac{\dd^3q}{(2\pi)^3 \sqrt{2E_\ve{q}}} \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \,\times \\
        & \quad \times \bigg\{ E_\ve{p} \left[ a_\ve{q}^\dagger e^{\img E_\ve{q} t} + b_{-\ve{q}} e^{-\img E_\ve{q} t} \right] \left[ a_\ve{p} e^{-\img E_\ve{p} t} - b_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] + \\
        & \quad + E_\ve{q} \left[ a_\ve{q}^\dagger e^{\img E_\ve{q} t} - b_{-\ve{q}} e^{-\img E_\ve{q} t} \right] \left[ a_\ve{p} e^{-\img E_\ve{p} t} + b_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] \bigg\} e^{\img (\ve{p} - \ve{q}) \cdot \ve{x}} \\
        &= \frac{1}{2} \int \frac{\dd^3p}{(2\pi)^3} \bigg\{ \left[ a_\ve{p}^\dagger e^{\img E_\ve{p} t} + b_{-\ve{p}} e^{-\img E_\ve{p} t} \right] \left[ a_\ve{p} e^{-\img E_\ve{p} t} - b_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] + \\
        & \quad + \left[ a_\ve{p}^\dagger e^{\img E_\ve{p} t} - b_{-\ve{p}} e^{-\img E_\ve{p} t} \right] \left[ a_\ve{p} e^{-\img E_\ve{p} t} + b_{-\ve{p}}^\dagger e^{\img E_\ve{p} t} \right] \bigg\} \\
...
\begin{equation}
  \Pi_\Psi = \img \bar{\Psi} \gamma^0 = \img \Psi^\dagger
...
\begin{equation}
  \Psi(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ a_{\ve{p},s} u^s(p) e^{-\img p_\mu x^\mu} + b_{\ve{p},s}^\dagger v^s(p) e^{\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p}}
  \label{eq:dirac-exp}
\end{equation}
\begin{equation}
  \bar{\Psi}(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ a_{\ve{p},s}^\dagger \bar{u}^s(p) e^{\img p_\mu x^\mu} + b_{\ve{p},s} \bar{v}^s(p) e^{-\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p}}
...
\begin{equation*}
  \begin{split}
    ...
    & \qquad \qquad \qquad \qquad \quad = \sqrt{2E_{\ve{p}_1}} \dots \sqrt{2E_{\ve{p}_n}} \sqrt{2E_{\ve{q}_1}} \dots \sqrt{2E_{\ve{q}_m}} a_{\ve{p}_1,s_1}^\dagger \dots a_{\ve{p}_n,s_n}^\dagger b_{\ve{q}_1,r_1}^\dagger \dots b_{\ve{q}_m,r_m}^\dagger \ket{0}
  \end{split}
\end{equation*}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \ham = \Pi_\Psi \pa_0 \Psi - \mathcal{L}_\text{D} = \img \Psi^\dagger \pa_0 \Psi - \bar{\Psi} \left( \img \gamma^0 \pa_0 + \img \gamma^i \pa_i - m \right) \Psi = \bar{\Psi} \left( -\img \gamma^i \pa_i + m \right) \Psi
    \end{equation*}
    Therefore, using \eeref{eq:dirac-exp}{eq:dirac-bar-exp} and \eref{eq:fourier-delta}:
    \begin{equation*}
      \begin{split}
        H
        &= \int \dd^3x\, \bar{\Psi} \left( -\img \gamma^i \pa_i + m \right) \Psi = \int \dd^3x\, \bar{\Psi} \left( -\img \bs{\gamma} \cdot \bs{\nabla} + m \right) \Psi \\
        &= \normord \int \dd^3x \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \int \frac{\dd^3q}{(2\pi)^3 \sqrt{2E_\ve{q}}} \sum_{s = 1,2} \sum_{r = 1,2} \left[ a_{\ve{p},s}^\dagger \bar{u}^s(p) e^{\img p_\mu x^\mu} + b_{\ve{p},s} \bar{v}^s(p) e^{-\img p_\mu x^\mu} \right] \times \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \times \left( -\img \bs{\gamma} \cdot \bs{\nabla} + m \right) \left[ a_{\ve{q},r} u^r(q) e^{-\img q_\mu x^\mu} + b_{\ve{q},r}^\dagger v^r(q) e^{\img q_\mu x^\mu} \right] \\
        &= \normord \int \dd^3x \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \int \frac{\dd^3q}{(2\pi)^3 \sqrt{2E_\ve{q}}} \sum_{s = 1,2} \sum_{r = 1,2} \left[ a_{\ve{p},s}^\dagger \bar{u}^s(p) e^{\img p_\mu x^\mu} + b_{\ve{p},s} \bar{v}^s(p) e^{-\img p_\mu x^\mu} \right] \times \\
        & \qquad \qquad \qquad \qquad \qquad \quad \ \ \, \times \left[ \left( \bs{\gamma} \cdot \ve{q} + m \right) a_{\ve{q},r} u^r(q) e^{-\img q_\mu x^\mu} + \left( - \bs{\gamma} \cdot \ve{q} + m \right) b_{\ve{q},r}^\dagger v^r(q) e^{\img q_\mu x^\mu} \right]
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        H
        &= \normord \int \dd^3x \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \int \frac{\dd^3q}{(2\pi)^3 \sqrt{2E_\ve{q}}} \sum_{s = 1,2} \sum_{r = 1,2} \left[ a_{\ve{p},s}^\dagger \bar{u}^s(\ve{p}) e^{\img E_\ve{p} t} + b_{-\ve{p},s} \bar{v}^s(-\ve{p}) e^{-\img E_\ve{p} t} \right] \hspace{-0.18em} \times \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \qquad \quad \ \ \times \gamma^0 E_\ve{q} \left[ a_{\ve{q},r} u^r(\ve{q}) e^{-i E_\ve{q} t} - b_{-\ve{q},r}^\dagger v^r(-\ve{q}) e^{\img E_\ve{q} t} \right] e^{\img (\ve{q} - \ve{p}) \cdot \ve{x}} \\
        &= \normord \int \frac{\dd^3p}{2(2\pi)^3} \sum_{s = 1,2} \sum_{r = 1,2} \left[ a_{\ve{p},s}^\dagger \bar{u}^s(\ve{p}) e^{\img E_\ve{p} t} + b_{-\ve{p},s} \bar{v}^s(-\ve{p}) e^{-\img E_\ve{p} t} \right] \times \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \times \gamma^0 \left[ a_{\ve{p},r} u^r(\ve{p}) e^{-\img E_\ve{p} t} - b_{-\ve{p},s}^\dagger v^r(-\ve{p}) e^{\img E_\ve{p} t} \right] \\
        &= \normord \int \frac{\dd^3p}{2(2\pi)^3} \sum_{s = 1,2} \sum_{r = 1,2} \Big[ a_{\ve{p},s}^\dagger a_{\ve{p},r} u^{s\dagger}(\ve{p}) u^r(\ve{p}) + b_{-\ve{p},s} a_{\ve{p},r} v^{s\dagger}(-\ve{p}) u^r(\ve{p}) e^{-2\img E_\ve{p} t} + \\
        & \qquad \qquad \qquad \qquad \qquad \quad - a_{\ve{p},s}^\dagger b_{-\ve{p},r}^\dagger u^{s\dagger}(\ve{p}) v^r(-\ve{p}) e^{2\img E_\ve{p} t} - b_{-\ve{p},s} b_{-\ve{p},r}^\dagger v^{s\dagger}(-\ve{p}) v^r(-\ve{p}) \Big]
      \end{split}
    \end{equation*}
...
%
\footnotetext{The spin-statistics theorem is implied by Lorentz invariance, positive energies and causality (see \cite{pauli}).}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \theta^{0i} = \frac{\pa \lag_\text{D}}{\pa (\pa_0 \Psi)} \pa^i \Psi = \bar{\Psi} \img \gamma^0 \pa^i \Psi = - \Psi^\dagger \img \pa_i \Psi
    \end{equation*}
    Thus, according to \eref{eq:4-mom-def}:
    \begin{equation*}
      \begin{split}
        \ve{P}
        &= \normord \int \dd^3x \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \int \frac{\dd^3q}{(2\pi)^3 \sqrt{2E_\ve{q}}} \sum_{s = 1,2} \sum_{r = 1,2} \left[ a_{\ve{p},s}^\dagger u^{s\dagger}(p) e^{\img p_\mu x^\mu} + b_{\ve{p},s} v^{s\dagger}(p) e^{-\img p_\mu x^\mu} \right] \times \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \quad \times (-i \bs{\nabla}) \left[ a_{\ve{q},r} u^r(q) e^{-\img q_\mu x^\mu} + b_{\ve{q},r}^\dagger v^r(q) e^{\img q_\mu x^\mu} \right] \\
        &= \normord \int \dd^3x \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \int \frac{\dd^3q}{(2\pi)^3 \sqrt{2E_\ve{q}}} \sum_{s = 1,2} \sum_{r = 1,2} \left[ a_{\ve{p},s}^\dagger u^{s\dagger}(p) e^{\img p_\mu x^\mu} + b_{\ve{p},s} v^{s\dagger}(p) e^{-\img p_\mu x^\mu} \right] \times \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \quad \times \ve{q} \left[ a_{\ve{q},r} u^r(q) e^{-\img q_\mu x^\mu} - b_{\ve{q},r}^\dagger v^r(q) e^{\img q_\mu x^\mu} \right] \\
        &= \normord \int \frac{\dd^3p}{(2\pi)^3} \frac{\ve{p}}{2E_\ve{p}} \sum_{s = 1,2} \sum_{r = 1,2} \left[ a_{\ve{p},s}^\dagger u^{s\dagger}(\ve{p}) e^{\img E_\ve{p} t} + b_{-\ve{p},s} v^{s\dagger}(-\ve{p}) e^{-\img E_\ve{p} t} \right] \times \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \quad \times \left[ a_{\ve{p},r} u^r(\ve{p}) e^{-\img E_\ve{p} t} - b_{-\ve{p},r}^\dagger v^r(-\ve{p}) e^{\img E_\ve{p} t} \right]
      \end{split}
    \end{equation*}
    Using \lref{lemma:haml-lem}, \eref{eq:uv-spin-id} and the antisymmetry $ \normord b_{\ve{p},s} b_{\ve{p},s}^\dagger = - b_{\ve{p},s}^\dagger b_{\ve{p},s} $:
    \begin{equation*}
...
Under a generic Lorentz transformation, the Dirac field $ \Psi $ transforms according to \eref{eq:dir-field-change}, i.e. $ \Psi'(x) = e^{-\frac{\img}{2} \omega_{\mu \nu} J^{\mu \nu}} \Psi(x) $, where the Lorentz generator $ J^{\mu \nu} $ is defined in \eref{eq:dir-field-tot-ang-mom}.

\begin{proposition}{Angular momentum}{}
  The conserved charge associated to the infinitesimal rotation \eref{eq:dir-field-change} is:
  \begin{equation}
    \ve{J} = \int \dd^3x\, \Psi^\dagger \left( \ve{x} \times (-\img \bs{\nabla}) + \tfrac{1}{2} \bs{\Sigma} \right) \Psi
  \end{equation}
\end{proposition}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \delta_0 \Psi = \theta \left( x^1 \pa^2 - x^2 \pa^1 - \tfrac{\img}{2} \Sigma^3 \right) \Psi = - \theta \left( x^1 \pa_2 - x^2 \pa_1 + \tfrac{\img}{2} \Sigma^3 \right) \Psi \equiv \theta \Delta \Psi
    \end{equation*}
    ...
    \begin{equation*}
      j^0 = \frac{\pa \lag_\text{D}}{\pa (\pa_0 \Psi)} \Delta \Psi = - \img \Psi^\dagger \left( (\ve{x} \times \bs{\nabla})^3 + \tfrac{\img}{2} \Sigma^3 \right) \Psi
    \end{equation*}
...
\begin{equation*}
  \begin{split}
    S_z
    &= \int \dd^3x \int \int \frac{\dd^3p\, \dd^3q}{(2\pi)^6 \sqrt{4 E_\ve{p} E_\ve{q}}} e^{\img (\ve{q} - \ve{p}) \cdot \ve{x}} \times \\
...
\begin{proposition}{Ladder operators}{}
  ...
  \begin{equation}
    \sqrt{2E_\ve{p}} a_{\ve{p},s} = \int \dd^3x\, e^{\img p_\mu x^\mu} \bar{u}^s(p) \gamma^0 \Psi(x)
    \qquad \qquad
    \sqrt{2E_\ve{p}} a_{\ve{p},s}\dg = \int \dd^3x\, e^{-\img p_\mu x^\mu} \bar{\Psi}(x) \gamma^0 u^s(p)
    \label{eq:dirac-ladd-op-a}
  \end{equation}
  \begin{equation}
    \sqrt{2E_\ve{p}} b_{\ve{p},s}\dg = \int \dd^3x\, e^{-\img p_\mu x^\mu} \bar{v}^s(p) \gamma^0 \Psi(x)
    \qquad \qquad
    \sqrt{2E_\ve{p}} b_{\ve{p},s} = \int \dd^3x\, e^{\img p_\mu x^\mu} \bar{\Psi}(x) \gamma^0 v^s(p)
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \Psi(x) = \int \frac{\dd^3k}{(2\pi)^3 \sqrt{2E_\ve{k}}} \sum_{s = 1,2} \left[ a_{\ve{k},s} u^s(\ve{k}) e^{-\img E_\ve{k} t} + b_{-\ve{k},s}\dg v^s(-\ve{k}) e^{\img E_\ve{k} t} \right] e^{\img \ve{k} \cdot \ve{x}}
    \end{equation*}
    Then:
    \begin{equation*}
      \begin{split}
        \int \dd^3x\, e^{\img p_\mu x^\mu} \Psi(x)
        & = \int \frac{\dd^3x \dd^3k}{(2\pi)^3 \sqrt{2E_\ve{k}}} \sum_{s = 1,2} \left[ a_{\ve{k},s} u^s(\ve{k}) e^{\img (E_\ve{p} - E_\ve{k}) t} \hspace{-0.1em} + b_{-\ve{k},s}\dg v^s(-\ve{k}) e^{\img (E_\ve{p} + E_\ve{k}) t} \right] \hspace{-0.1em} e^{\img (\ve{k} - \ve{p}) \cdot \ve{x}} \\
        & = \int \frac{\dd^3k}{\sqrt{2E_\ve{k}}} \delta^{(3)}(\ve{k} - \ve{p}) \sum_{s = 1,2} \left[ a_{\ve{k},s} u^s(\ve{k}) e^{\img (E_\ve{p} - E_\ve{k}) t} + b_{-\ve{k},s}\dg v^s(-\ve{k}) e^{\img (E_\ve{p} + E_\ve{k}) t} \right] \\
        & = \frac{1}{\sqrt{2E_\ve{p}}} \sum_{r = 1,2} \left[ a_{\ve{p},r} u^r(\ve{p}) + b_{-\ve{p},r}\dg v^r(-\ve{p}) e^{2\img E_\ve{p} t} \right]
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      \int \dd^3x\, e^{\img p_\mu x^\mu} \bar{u}^s(p) \gamma^0 \Psi(x) = \sqrt{2E_\ve{p}} a_{\ve{p},s}
    \end{equation*}
    Analogously:
    \begin{equation*}
      \int \dd^3x\, e^{-\img p_\mu x^\mu} \bar{v}^s(p) \gamma^0 \Psi(x) = \sqrt{2E_\ve{p}} b_{\ve{p},s}\dg
    \end{equation*}
    To find the remaining ladder operators, either repeat the previous steps with $ \bar{\Psi}(x) $ or use (as $ (\gamma^\mu)^2 = \mt{I}_4 $):
    \begin{equation}
...
\begin{equation*}
  \Psi_\text{L}(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ a_{\ve{p},s} u_\text{L}^s(p) e^{-\img p_\mu x^\mu} + b_{\ve{p},s}^\dagger v_\text{L}^s(p) e^{\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p}}
\end{equation*}
...
\begin{equation*}
  \begin{split}
    \parity \Psi(x) \parity
    &= \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ \eta_a a_{-\ve{p},s} u^s(p) e^{-\img p_\mu x^\mu} + \eta_b b_{-\ve{p},s}^\dagger v^s(p) e^{\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p}} \\
    &= \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ \eta_a a_{-\ve{p},s} u^s(p) e^{-\img E_\ve{p} t + \img \ve{p} \cdot \ve{x}} + \eta_b b_{-\ve{p},s}^\dagger v^s(p) e^{\img E_\ve{p} t - \img \ve{p} \cdot \ve{x}} \right]_{p^0 = E_\ve{p}} \\
  \end{split}
\end{equation*}
...
\begin{equation*}
  \begin{split}
    \parity \Psi(x) \parity
    &= \int \frac{\dd^3p'}{(2\pi)^3 \sqrt{E_{\ve{p}'}}} \sum_{s = 1,2} \left[ \eta_a a_{\ve{p}',s} \gamma^0 u^s(p') e^{-\img E_{\ve{p}'} t + \img \ve{p}' \cdot \ve{x}'} - \eta_b b_{\ve{p}',s}^\dagger \gamma^0 v^s(p') e^{\img E_{\ve{p}'} t - \img \ve{p}' \cdot \ve{x}'} \right]_{p'^0 = E_{\ve{p}'}} \\
    &= \gamma^0 \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ \eta_a a_{\ve{p},s} u^s(p) e^{-\img p_\mu x'^\mu} - \eta_b b_{\ve{p},s}^\dagger v^s(p) e^{\img p_\mu x'^\mu} \right]_{p^0 = E_\ve{p}}
  \end{split}
\end{equation*}
...
Recall \eref{eq:dir-spin-charge-conj}: charge conjugation acts on the classical Dirac field as $ \Psi \mapsto -\img \gamma^2 \Psi^* $.
...
\begin{lemma}[before upper = {\tcbtitle}]{Charge conjugation on spinors}{spinor-charge-conj}
  \begin{equation}
    \chargec u^s(p) \chargec = -\img \gamma^2 \left[ v^s(p) \right]^*
    \qquad \qquad
    \chargec v^s(p) \chargec = -\img \gamma^2 \left[ u^s(p) \right]^*
...
\begin{proposition}{Charge conjugation on Dirac fields}{}
  ...
  \begin{equation}
    \chargec \Psi(x) \chargec = -\img \eta_c \gamma^2 [\Psi(x)]^*
  \end{equation}
\end{proposition}
  ...
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        ...
        &= \eta_c \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ b_{\ve{p},s} \chargec u^s(p) \chargec e^{-\img p_\mu x^\mu} + a_{\ve{p},s}^\dagger \chargec v^s(p) \chargec e^{\img p_\mu x^\mu} \right] \\
        &= -\img \eta_c \gamma^2 \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ b_{\ve{p},s} [v^s(p)]^* e^{-\img p_\mu x^\mu} + a_{\ve{p},s}^\dagger [u^s(p)]^* e^{\img p_\mu x^\mu} \right] \\
        & = -\img \eta_c \gamma^2 [\Psi(x)]^*
      \end{split}
    \end{equation*}
    which is the thesis.
  \end{proof}
  ...
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        ...
        &= \timer e^{\img H t} \Psi(\ve{x}) e^{-\img H t} \timer \ket{0} = e^{\img H t} \timer \Psi(\ve{x}) \timer e^{-\img H t} \ket{0} = e^{\img H t} \timer \Psi(\ve{x}) \timer \ket{0} \\
        &= \Psi(-t,\ve{x}) \ket{0} = e^{-\img H t} \Psi(\ve{x}) e^{\img H t} \ket{0} = e^{-\img H t} \Psi(\ve{x}) \ket{0}
      \end{split}
    \end{equation*}
    assuming $ H \ket{0} = 0 $. But the first line is a sum of negative frequencies only, while the second line is a sum of positive frequencies only, which is absurd.
  \end{proof}
\end{proofbox}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      u^{-s}(-\ve{p}) =
      \begin{pmatrix}
        \sqrt{\tilde{p}^\mu \sigma_\mu} (-\img \sigma^2 [\xi^s]^*) \\
        \sqrt{\tilde{p}^\mu \bar{\sigma}_\mu} (-\img \sigma^2 [\xi^s]^*)
      \end{pmatrix}
      =
      \begin{pmatrix}
        -\img \sigma^2 \sqrt{p^\mu \sigma_\mu^*} [\xi^s]^* \\
        -\img \sigma^2 \sqrt{p^\mu \bar{\sigma}_\mu^*} [\xi^s]^*
      \end{pmatrix}
      = -\img \begin{pmatrix} \sigma^2 & 0 \\ 0 & \sigma^2 \end{pmatrix} [u^s(\ve{p})]^*
    \end{equation*}
    Noting that $ \img \diag(\sigma^2,\sigma^2) = \gamma^1 \gamma^3 $ completes the proof. On the other hand:
    \begin{equation*}
      \begin{split}
        v^{-s}(-\ve{p})
        &=
        ...
        \end{pmatrix}\\
        &= -\img \begin{pmatrix} \sigma^2 & 0 \\ 0 & \sigma^2 \end{pmatrix}
        \begin{pmatrix}
          \sqrt{p^\mu \sigma_\mu^*} (-\img \sigma^2 [\xi^s]^*) \\
          - \sqrt{p^\mu \bar{\sigma}_\mu^*} (-\img \sigma^2 [\xi^s]^*)
        \end{pmatrix}
...
\begin{proofbox}
 \begin{proof}
   ...
   \begin{equation*}
       \begin{split}
         \timer \Psi(x) \timer
         &= \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \timer \left[ a_{\ve{p},s} u^s(p) e^{-\img p_\mu x^\mu} + b_{\ve{p},s}^\dagger v^s(p) e^{\img p_\mu x^\mu} \right] \timer \\
         &= \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ a_{-\ve{p},-s} [u^s(p)]^* e^{\img p_\mu x^\mu} + b_{-\ve{p},-s}^\dagger [v^s(p)]^* e^{-\img p_\mu x^\mu} \right] \\
         &= - \gamma^3 \gamma^1 \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} \left[ a_{\tilde{\ve{p}},-s} u^{-s}(\tilde{p}) e^{-\img \tilde{p}_\mu \tilde{x}^\mu} + b_{\tilde{\ve{p}},-s}^\dagger v^{-s}(\tilde{p}) e^{\img \tilde{p}_\mu \tilde{x}^\mu} \right] \\
         &= \gamma^1 \gamma^3 \int \frac{-\dd^3\tilde{p}}{(2\pi)^3 \sqrt{2E_{\tilde{\ve{p}}}}} \sum_{s = 1,2} \left[ a_{\tilde{\ve{p}},s} u^s(\tilde{p}) e^{-\img \tilde{p}_\mu \tilde{x}^\mu} + b_{\tilde{\ve{p}},s}^\dagger v^s(\tilde{p}) e^{\img \tilde{p}_\mu \tilde{x}^\mu} \right]
...
\begin{table}
  ...
  \begin{tabular}{ccccccc}
    \hline
    \rule{0pt}{2.5ex} & $ \bar{\Psi} \Psi $ & $ \bar{\Psi} \gamma^5 \Psi $ & $ \bar{\Psi} \gamma^\mu \Psi $ & $ \bar{\Psi} \gamma^\mu \gamma^5 \Psi $ & $ \bar{\Psi} \sigma^{\mu \nu} \Psi $ & $ \pa_\mu $ \\
    \hline
  ...
  \end{tabular}
  \caption{Eigenvalues of fermion bilinears and derivative operator, with the shorthand $ (-1)^\mu \equiv (+1,-1,-1,-1) $.}
...
\begin{equation}
  A_\mu(x) = 2\Re\{\epsilon_\mu(k) e^{-\img k_\mu x^\mu}\}
\end{equation}
...
\begin{example}{Linear and circular polarization}{}
  ...
  \begin{equation}
    \bs{\epsilon}_\text{R} = \frac{\bs{\epsilon}_1 + \img \bs{\epsilon}_2}{\sqrt{2}}
    \qquad
    \bs{\epsilon}_\text{L} = \frac{\bs{\epsilon}_1 - \img \bs{\epsilon}_2}{\sqrt{2}}
...
\begin{equation}
  \Psi(x) \mapsto e^{\img q \alpha(x)} \Psi(x)
...
\begin{equation}
  D_\mu \Psi \defeq (\pa_\mu + \img q A_\mu) \Psi
\end{equation}

\begin{proposition}[before upper = {\tcbtitle}]{}{}
  \begin{equation}
    D_\mu \Psi(x) \mapsto e^{\img q \alpha(x)} D_\mu \Psi(x)
...
\begin{proofbox}
  \begin{proof}
      $ D_\mu \Psi \mapsto \left[ \pa_\mu + \img q (A_\mu - \pa_\mu \alpha) \right] e^{\img q \alpha} \Psi = e^{\img q \alpha} \left[ \img q \pa_\mu \alpha + \pa_\mu + \img q A_\mu - \img q \pa_\mu \alpha \right] \Psi = e^{\img q \alpha} D_\mu \Psi $
  \end{proof}
\end{proofbox}

The Lagrangian with a local $ \Un{1} $ symmetry is found replacing $ \pa_\mu \mapsto D_\mu $ (\bctxt{minimal coupling}): the global symmetry is gauged to a local symmetry, resulting in a gauge theory with gauge field $ A_\mu $.
Applying this to \eref{eq:dirac-lagrangian}:
\begin{equation}
  \lag_\text{D} = \bar{\Psi} (\img \slashed{\pa} - m) \Psi - q A_\mu \bar{\Psi} \gamma^\mu \Psi
\end{equation}
...
A complex scalar field has a global $ \Un{1} $ symmetry $ \phi \mapsto e^{\img q \alpha} \phi $, thus the covariant derivative is identical to \eref{eq:qed-cov-der} and the gauged Lagrangian reads (recall \eref{eq:compl-scalar-lag}):
\begin{equation}
  \lag = \pa_\mu \phi \pa^\mu \phi + \img q A^\mu (\phi \pa_\mu \phi^* - \phi^* \pa_\mu \phi) + q^2 \abs{\phi}^2 A_\mu A^\mu - m^2 \phi^* \phi
\end{equation}
where $ j_\mu \defeq \img \phi^* \overleftrightsmallarrow{\pa_\mu} \phi $ is the Noether current associated to the global $ \Un{1} $ symmetry.
...
\begin{equation*}
  \ve{A}(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2\omega_\ve{p}}} \sum_{\lambda = 1,2} \left[ \bs{\epsilon}(\ve{p},\lambda) a_{\ve{p},\lambda} e^{-\img p_\mu x^\mu} + \bs{\epsilon}^*(\ve{p},\lambda)a^*_{\ve{p},\lambda} e^{\img p_\mu x^\mu} \right]_{p^0 = \omega_\ve{p}}
\end{equation*}
...
\begin{equation}
  \ve{A}(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2\omega_\ve{p}}} \sum_{\lambda = 1,2} \left[ \bs{\epsilon}(\ve{p},\lambda) a_{\ve{p},\lambda} e^{-\img p_\mu x^\mu} + \bs{\epsilon}^*(\ve{p},\lambda)a\dg_{\ve{p},\lambda} e^{\img p_\mu x^\mu} \right]_{p^0 = \omega_\ve{p}}
...
\begin{lemma}[before upper = {\tcbtitle}]{}{}
  \begin{equation}
    [A^i(t,\ve{x}) , E^j(t,\ve{y})] = - \img \int \frac{\dd^3k}{(2\pi)^3} e^{i \ve{k} \cdot (\ve{x} - \ve{y})} \left( \delta^{ij} - \frac{k^i k^j}{\ve{k}^2} \right)
  \end{equation}
\end{lemma}
...
\begin{equation}
  a_{\ve{k},\pm}\dg \defeq \frac{1}{\sqrt{2}} \left( a_{\ve{k},1}\dg \pm \img a_{\ve{k},2}\dg \right)
\end{equation}
...
\begin{align*}
  S^3 a_{\ve{k},1}\dg \ket{0} = + \img a_{\ve{k},2}\dg \ket{0} & \qquad & S^3 a_{\ve{k},+}\dg \ket{0} = + a_{\ve{k},+}\dg \ket{0} \\
  S^3 a_{\ve{k},2}\dg \ket{0} = - \img a_{\ve{k},1}\dg \ket{0} & \qquad & S^3 a_{\ve{k},-}\dg \ket{0} = - a_{\ve{k},-}\dg \ket{0}
\end{align*}
...
\begin{equation}
  A_\mu(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2\omega_\ve{p}}} \sum_{\lambda = 0}^{3} \left[ \epsilon_\mu(\ve{p},\lambda) a_{\ve{p},\lambda} e^{-\img p_\mu x^\mu} + \epsilon_\mu^*(\ve{p},\lambda) a_{\ve{p},\lambda}\dg e^{\img p_\mu x^\mu} \right]_{p^0 = \omega_\ve{p}}
...
\begin{equation*}
  (\pa_\mu A^\mu)^+ \equiv -\img \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2\omega_\ve{p}}} \sum_{\lambda = 0}^{3} p_\mu \epsilon^\mu(\ve{p},\lambda) a_{\ve{p},\lambda} e^{-\img p_\mu x^\mu} = {(\pa_\mu A^\mu)}\dg
\end{equation*}
...
\end{equation*}
This means that $ \ket{\phi} $ is orthogonal to all physical states $ \ket{\varphi} $. Moreover, only transverse states contribute to the energy and to the momentum, as $ H , \ve{P} \sim - \eta^{\lambda \lambda'} a_{\ve{k},\lambda}\dg a_{\ve{k},\lambda'} $ and (as $ c_0 + c_3 = 0 $):
\begin{equation*}
  (a_{\ve{k},0} - a_{\ve{k},3}) \ket{\psi} = 0
  \quad \implies \quad
  \braket{\varphi' | -a_{\ve{k},0}\dg a_{\ve{k},0} + a_{\ve{k},3}\dg a_{\ve{k},3} | \varphi} = \braket{\varphi' | (-a_{\ve{k},0}\dg + a_{\ve{k},3}\dg) a_{\ve{k},3} | \varphi} = 0
\end{equation*}
...
\begin{proposition}{Ladder operators}{}
  ...
  \begin{equation}
    \sqrt{2\omega_\ve{k}} a_{\ve{k},\lambda} = \img \bs{\epsilon}(\ve{k},\lambda) \cdot \int \dd^3x\, e^{\img k_\mu x^\mu} \smlra{\pa_0} \ve{A}(x)
    \label{eq:qed-lad-1}
  \end{equation}
  \begin{equation}
    \sqrt{2\omega_\ve{k}} a_{\ve{k},\lambda}\dg = - \img \bs{\epsilon}^*(\ve{k},\lambda) \cdot \int \dd^3x\, e^{-\img k_\mu x^\mu} \smlra{\pa_0} \ve{A}(x)
    \label{eq:qed-lad-2}
  \end{equation}
\end{proposition}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \pa_0 \ve{A}(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2\omega_\ve{p}}} \sum_{\lambda = 1,2} \left[ -\img \omega_\ve{p} \bs{\epsilon}(\ve{p},\lambda) a_{\ve{p},\lambda} e^{-\img p_\mu x^\mu} + \img \omega_\ve{p} \bs{\epsilon}^*(\ve{p},\lambda) a_{\ve{p},\lambda}\dg e^{\img p_\mu x^\mu} \right]_{p^0 = \omega_\ve{p}}
    \end{equation*}
    Therefore:
    \begin{equation*}
      \begin{split}
        \int \dd^3x\, e^{\img k_\mu x^\mu} \ve{A}(x)
        & = \int \dd^3x \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2\omega_\ve{p}}} \sum_{\lambda = 1,2} \left[ \bs{\epsilon}(\ve{p},\lambda) a_{\ve{p},\lambda} e^{\img (k - p)_\mu x^\mu} \hspace{-0.1em} + \bs{\epsilon}^*(\ve{p},\lambda) a_{\ve{p},\lambda}\dg e^{\img (k + p)_\mu x^\mu} \right] \\
        & = \frac{1}{\sqrt{2\omega_\ve{k}}} \sum_{\lambda = 1,2} \left[ \bs{\epsilon}(\ve{k},\lambda) a_{\ve{k},\lambda} + \bs{\epsilon}^*(-\ve{k},\lambda) a_{-\ve{k},\lambda}\dg e^{2\img \omega_\ve{k}} \right]
      \end{split}
    \end{equation*}
    \begin{equation*}
      \begin{split}
        \int \dd^3x\, e^{\img k_\mu x^\mu} \pa_0 \ve{A}(x)
        & = \frac{i \omega_\ve{k}}{\sqrt{2\omega_\ve{k}}} \sum_{\lambda = 1,2} \left[ - \bs{\epsilon}(\ve{k},\lambda) a_{\ve{k},\lambda} + \bs{\epsilon}^*(-\ve{k},\lambda) a_{-\ve{k},\lambda}\dg e^{2\img \omega_\ve{k}} \right]
      \end{split}
    \end{equation*}
    These can be combined as:
    \begin{equation*}
      \int \dd^3x\, e^{\img k_\mu x^\mu} \smlra{\pa_0} \ve{A}(x) = \frac{\img \omega_\ve{k}}{\sqrt{2\omega_\ve{k}}} \sum_{\lambda = 1,2} \left[ -2 \bs{\epsilon}(\ve{k},\lambda) a_{\ve{k},\lambda} \right] = - \img \sqrt{2\omega_\ve{k}} \sum_{\lambda = 1,2} \bs{\epsilon}(\ve{k},\lambda) a_{\ve{k},\lambda}
    \end{equation*}
    ...
    \begin{equation*}
      \int \dd^3x\, e^{-\img k_\mu x^\mu} \smlra{\pa_0} \ve{A}(x) = \frac{\img \omega_\ve{k}}{\sqrt{2\omega_\ve{k}}} \sum_{\lambda = 1,2} \left[ 2 \bs{\epsilon}^*(\ve{k},\lambda) a_{\ve{k},\lambda}\dg \right] = \img \sqrt{2\omega_\ve{k}} \sum_{\lambda = 1,2} \bs{\epsilon}^*(\ve{k},\lambda) a_{\ve{k},\lambda}\dg
    \end{equation*}
...
Writing them in Lorentz-covariant form (using $ \epsilon^0 = \epsilon^3 = 0 $):
  \begin{equation}
    \sqrt{2\omega_\ve{p}} a_{\ve{p},\lambda} = \img \epsilon^\mu(\ve{p},\lambda) \int \dd^3x\, e^{\img p_\mu x^\mu} \smlra{\pa_0} A_\mu(x)
    \label{eq:qed-lad-cov-1}
  \end{equation}
  \begin{equation}
    \sqrt{2\omega_\ve{p}} a_{\ve{p},\lambda}\dg = - \img {\epsilon^\mu}^*(\ve{p},\lambda) \int \dd^3x\, e^{-\img p_\mu x^\mu} \smlra{\pa_0} A_\mu(x)
