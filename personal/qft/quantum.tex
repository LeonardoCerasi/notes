...
\begin{equation}
  \braket{f,g} \defeq \img \int \dd^3x\, f^*(x) \smlra{\pa}_0 g(x) = \img \int \dd^3x\, \left[ f^*(x) \pa_0 g(x) - \pa_0 f^*(x) g(x) \right] \equiv \img \int \dd^3x\, W_0[f^*,g](x)
\end{equation}
  ...
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        ...
        & = \img \int \dd^3x\, f^*_\ve{p}(x) \smlra{\pa}_0 f_\ve{q}(x) = \img \int \frac{\dd^3x}{(2\pi)^3 \sqrt{4 E_\ve{p} E_\ve{q}}} e^{\img (\ve{q} - \ve{p}) \cdot \ve{x}} \left( e^{\img E_\ve{p} t} \smlra{\pa}_0 e^{-\img E_\ve{q} t}  \right) \\
...
\begin{theorem}{Ladder operators}{kg-ladder-op}
  ...
  \begin{equation}
    \sqrt{2E_\ve{p}} a_\ve{p} = \img \int \dd^3x\, e^{\img p_\mu x^\mu} \smlra{\pa}_0 \phi(x)
    \qquad \qquad
    \sqrt{2E_\ve{p}} a_\ve{p}\dg = -\img \int \dd^3x\, e^{-\img p_\mu x^\mu} \smlra{\pa}_0 \phi(x)
...
\begin{equation}
  \covder_\mu \Psi \defeq (\pa_\mu + \img q A_\mu) \Psi
\end{equation}

\begin{proposition}[before upper = {\tcbtitle}]{}{}
  \begin{equation}
    \covder_\mu \Psi(x) \mapsto e^{\img q \alpha(x)} \covder_\mu \Psi(x)
...
\begin{proofbox}
  \begin{proof}
      $ \covder_\mu \Psi \mapsto \left[ \pa_\mu + \img q (A_\mu - \pa_\mu \alpha) \right] e^{\img q \alpha} \Psi = e^{\img q \alpha} \left[ \img q \pa_\mu \alpha + \pa_\mu + \img q A_\mu - \img q \pa_\mu \alpha \right] \Psi = e^{\img q \alpha} \covder_\mu \Psi $
  \end{proof}
\end{proofbox}
...
\begin{proposition}{Ladder operators}{}
  ...
  \begin{equation}
    \sqrt{2\omega_\ve{k}} a_{\ve{k},\lambda} = \img \bs{\epsilon}(\ve{k},\lambda) \cdot \int \dd^3x\, e^{\img k_\mu x^\mu} \smlra{\pa}_0 \ve{A}(x)
    \label{eq:qed-lad-1}
  \end{equation}
  \begin{equation}
    \sqrt{2\omega_\ve{k}} a_{\ve{k},\lambda}\dg = - \img \bs{\epsilon}^*(\ve{k},\lambda) \cdot \int \dd^3x\, e^{-\img k_\mu x^\mu} \smlra{\pa}_0 \ve{A}(x)
    \label{eq:qed-lad-2}
  \end{equation}
\end{proposition}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \int \dd^3x\, e^{\img k_\mu x^\mu} \smlra{\pa}_0 \ve{A}(x) = \frac{\img \omega_\ve{k}}{\sqrt{2\omega_\ve{k}}} \sum_{\lambda = 1,2} \left[ -2 \bs{\epsilon}(\ve{k},\lambda) a_{\ve{k},\lambda} \right] = - \img \sqrt{2\omega_\ve{k}} \sum_{\lambda = 1,2} \bs{\epsilon}(\ve{k},\lambda) a_{\ve{k},\lambda}
    \end{equation*}
    ...
    \begin{equation*}
      \int \dd^3x\, e^{-\img k_\mu x^\mu} \smlra{\pa}_0 \ve{A}(x) = \frac{\img \omega_\ve{k}}{\sqrt{2\omega_\ve{k}}} \sum_{\lambda = 1,2} \left[ 2 \bs{\epsilon}^*(\ve{k},\lambda) a_{\ve{k},\lambda}\dg \right] = \img \sqrt{2\omega_\ve{k}} \sum_{\lambda = 1,2} \bs{\epsilon}^*(\ve{k},\lambda) a_{\ve{k},\lambda}\dg
    \end{equation*}
...
Writing them in Lorentz-covariant form (using $ \epsilon^0 = \epsilon^3 = 0 $):
  \begin{equation}
    \sqrt{2\omega_\ve{p}} a_{\ve{p},\lambda} = \img \epsilon^\mu(\ve{p},\lambda) \int \dd^3x\, e^{\img p_\mu x^\mu} \smlra{\pa}_0 A_\mu(x)
    \label{eq:qed-lad-cov-1}
  \end{equation}
  \begin{equation}
    \sqrt{2\omega_\ve{p}} a_{\ve{p},\lambda}\dg = - \img {\epsilon^\mu}^*(\ve{p},\lambda) \int \dd^3x\, e^{-\img p_\mu x^\mu} \smlra{\pa}_0 A_\mu(x)
