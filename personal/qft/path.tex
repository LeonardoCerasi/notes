...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      Z_0[J] = \int \mathcal{D}\chi\, \exp \left[ - \frac{\img}{2} \braket{\chi | \hat{A} | \chi} + \frac{\img}{2} \braket{J | \hat{A}^{-1} | J} \right] = Z_0[0] \exp \left[ \frac{i}{2} \braket{J | \hat{A}^{-1} | J} \right]
    \end{equation*}
...
\begin{example}{$ 2 $-point Green function}{}
  ...
  \begin{equation*}
    \braket{0 | \tempord\{\Psi(x_1) \bar{\Psi}(x_2)\} | 0} = \frac{\int \mathcal{D} \bar{\Psi} \mathcal{D} \Psi\, \Psi(x_1) \bar{\Psi}(x_2) \exp \left[ \img \int \dd^4x\, \bar{\Psi} ( \img \slashed{\pa} - m + i\epsilon ) \Psi \right]}{\int \mathcal{D} \bar{\Psi} \mathcal{D} \Psi\, \exp \left[ \img \int \dd^4x\, \bar{\Psi} ( \img \slashed{\pa} - m + i\epsilon ) \Psi \right]}
  \end{equation*}
