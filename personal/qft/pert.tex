...
In the Schrödinger picture, states are treated as time-dependent, while operators are treated as time-independent. Consider an initial state $ \ket{\psi(0)} \equiv \ket{\psi} $: its time-evolution is:
\begin{equation}
  \ket{\psi(t)} = e^{-\img H t} \ket{\psi}
\end{equation}
In this picture, the amplitude for a process $ \ket{a(t_0)} \rightarrow \ket{b(t)} $ is:
\begin{equation}
  \mathcal{A} = \braket{b | e^{-\img H (t - t_0)} | a} \eqdef \braket{b | S(t,t_0) | a}
  \label{eq:schr-ampl}
\end{equation}
...
\begin{equation}
  ...
  \label{eq:s-t-matrix}
\end{equation}
where the \bctxt{$ T $-matrix} contains the information on the interactions, while the identity $ \mt{I} $ only represents a part of the incident wave-packet unaffected by interactions.

\subsection{Heisenberg picture}

In the Heisenberg picture, states are treated as time-independent, while operators are treated as time-dependent. This picture is better suited for QFT, as fields (which are operators) depend both on $ \ve{x} $ and $ t $, therefore the Heisenberg picture is natural in light of Lorentz covariance. \\
Given a state $ \ket{\psi(t)} $ in the Schrödinger picture, in the Heisenberg picture it is defined as:
\begin{equation}
  \ket{\psi,t} \defeq e^{\img H t} \ket{\psi(t)}
\end{equation}
which is manifestly time-independent. An operator $ \mathcal{O} $ in the Schrödinger picture instead becomes:
\begin{equation}
  \mathcal{O}(t) \defeq e^{\img H t} \mathcal{O} e^{-\img H t}
\end{equation}
...
%
\footnotetext{If that was not the case, then canonical quantization would imply $ Z = 1 $, i.e. that $ \phi(x) $ is a free field. For details, see Sec. 5.1.2 of \cite{itz-zub}.}
...
\begin{proposition}{Time-dependent ladder operators}{}
  ...
  \begin{equation}
    \frac{\dd}{\dd t} a_\ve{p}(t) = \img \left[ H_\text{int} , a_\ve{p}(t) \right]
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation}
      \frac{\dd}{\dd t} \mathcal{O}(t) = \img [H , \mathcal{O}] + \frac{\pa}{\pa t} \mathcal{O}(t)
    \end{equation}
    Using \eref{eq:frsf-ladder}, the explicit time-dependece of $ a_\ve{p}(t) $ is solved as:
    \begin{equation*}
      \frac{\pa}{\pa t} a_\ve{p}(t) = \frac{i}{\sqrt{2E_\ve{p}}} \frac{\pa}{\pa t} \int \dd^3x \left[ \pa_0 \phi(x) - \img E_\ve{p} \phi(x) \right] e^{\img p_\mu x^\mu}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        ...
        & = \frac{i}{\sqrt{2E_\ve{p}}} \left[ \frac{\dd}{\dd t} - \pa_0 \phi(x) \frac{\pa}{\pa \phi} - \pa_0^2 \phi(x) \frac{\pa}{\pa (\pa_0 \phi)} \right] \int \dd^3x \left[ \pa_0 \phi(x) - \img E_\ve{p} \phi(x) \right] e^{\img p_\mu x^\mu} \\
        & = \frac{\img}{\sqrt{2E_\ve{p}}} \int \dd^3x \left[ \pa_0^2 \phi(x) -\img E_\ve{p} \pa_0 \phi(x) + \img E_\ve{p} \pa_0 \phi(x) - (\img E_\ve{p})^2 \phi(x) \right] e^{\img p_\mu x^\mu} + \\
        & \qquad \qquad \qquad \qquad \qquad \qquad - \frac{\img}{\sqrt{2E_\ve{p}}} \int \dd^3x \left[ - \img E_\ve{p} \pa_0 \phi(x) + \pa_0^2 \phi(x) \right] e^{\img p_\mu x^\mu} \\
        & = \frac{\img}{\sqrt{2E_\ve{p}}} \int \dd^3x \left[ \img E_\ve{p} \pa_0 \phi(x) - (\img E_\ve{p})^2 \phi(x) \right] e^{i p_\mu x^\mu} = \img E_\ve{p} a_\ve{p}(t)
      \end{split}
    \end{equation*}
...
\begin{equation}
  \sqrt{2E_\ve{p}} {a_\ve{p}^\text{in,out}}\dg = - \frac{\img}{\sqrt{Z}} \lim_{t \rightarrow \mp \infty} \int \dd^3x\, e^{-\img p_\mu x^\mu} \smlra{\pa_0} \phi(x) = -\img \int \dd^3x\, e^{-\img p_\mu x^\mu} \smlra{\pa}_0 \phi_\text{in,out}(x)
...
\begin{equation}
  \phi_\text{in,out}(x) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \left[ a_\ve{p}^\text{in,out} e^{-\img p_\mu x^\mu} + {a_\ve{p}^\text{in,out}}\dg e^{\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p}}
\end{equation}
...
\begin{proofbox}
  \begin{proof}
    The thesis is equivalent to\footnote{Requires proof.}:
    \begin{equation}
      [\hat{P}_\mu , \phi_\text{in,out}(x)] = -\img \pa_\mu \phi_\text{in,out}(x)
    \end{equation}
    To show this, first note that \eref{eq:in-out-lad-temp} is equivalent to:
    \begin{equation*}
      a_\ve{k}(t) = a_\ve{k}^\text{in} + \img \int_{-\infty}^t \dd \tau\, [H_\text{int} , a_\ve{k}(\tau)] \equiv a_\ve{k}^\text{int} + \img \int_{-\infty}^t \dd \tau \int \frac{\dd^3x}{(2\pi)^3 \sqrt{2E_\ve{k}}} e^{\img k_\mu x^\mu} \chi[\phi(\tau,\ve{x})]
    \end{equation*}
    where $ \chi[\phi] $ is a certain functional of $ \phi $. Then:
    \begin{equation*}
      \begin{split}
        \phi(x)
        & = \int \frac{\dd^3k}{(2\pi)^3 \sqrt{2E_\ve{k}}} \left[ a_\ve{k} e^{-\img k_\mu x^\mu} + a_\ve{k}\dg e^{\img k_\mu x^\mu} \right]_{k^0 = E_\ve{k}} \\
        & = \int \frac{\dd^3k}{(2\pi)^3 \sqrt{2E_\ve{k}}} \left[ a_\ve{k}^\text{in} e^{-\img k_\mu x^\mu} + {a_\ve{k}^\text{in}}\dg e^{\img k_\mu x^\mu} \right]_{k^0 = E_\ve{k}} + \\
        & \quad + \img \int \frac{\dd^3k}{(2\pi)^3 \sqrt{2E_\ve{k}}} \int_{-\infty}^t \dd \tau \int \frac{\dd^3y}{(2\pi)^3 \sqrt{2E_\ve{k}}} \left[ \chi[\phi(\tau,\ve{y})] e^{-\img k_\mu (x^\mu - y^\mu)} - \text{h.c.} \right]_{k^0 =  E_\ve{k}} \\
    ...
    \end{equation*}
    As the source terms vanishes as $ t \rightarrow -\infty $ (with $ x^0 \equiv t $), this equation holds for $ \phi_\text{in} $ too, hence the thesis. The proof for $ 
    \phi_\text{out} $ is analogous.
  \end{proof}
\end{proofbox}
...
\begin{lemma}[before upper = {\tcbtitle}]{}{scal-in-out-rel}
  \begin{equation}
    \sqrt{2E_\ve{p}} ({a_\ve{p}^\text{in}}\dg - {a_\ve{p}^\text{out}}\dg) = \frac{\img}{\sqrt{Z}} \int \dd^4x\, e^{-\img p_\mu x^\mu} (\Box + m^2) \phi(x)
    \label{eq:lsz-scal-op}
  \end{equation}
  \begin{equation}
    \sqrt{2E_\ve{p}} (a_\ve{p}^\text{out} - a_\ve{p}^\text{in}) = \frac{\img}{\sqrt{Z}} \int \dd^4x\, e^{\img p_\mu x^\mu} (\Box + m^2) \phi(x)
  \end{equation}
\end{lemma}
...
\begin{proofbox}
  \begin{proof}
    ...
    \end{equation}
    Applying this to $ f(t,\ve{x}) = -\img Z^{-1/2} e^{-\img k_\mu x^\mu} \smlra{\pa_0} \phi(x) $ and using \eref{eq:in-out-lad-op}:
    \begin{equation*}
      \begin{split}
        \sqrt{2E_\ve{p}} ({a_\ve{p}^\text{out}}\dg - {a_\ve{p}^\text{in}}\dg)
        & = - \frac{\img}{\sqrt{Z}} \int \dd^4x\, \pa_0 \left[ e^{-\img p_\mu x^\mu} \smlra{\pa_0} \phi(x) \right] \\
        & = - \frac{\img}{\sqrt{Z}} \int \dd^4x\, \pa_0 \left[ e^{-\img p_\mu x^\mu} \pa_0 \phi(x) - \phi(x) \pa_0 e^{-\img p_\mu x^\mu} \right] \\
        & = - \frac{\img}{\sqrt{Z}} \int \dd^4x \left[ e^{-\img p_\mu x^\mu} \pa_0^2 \phi(x) - \phi(x) \pa_0^2 e^{-\img p_\mu x^\mu} \right] \\
        & = - \frac{\img}{\sqrt{Z}} \int \dd^4x \left[ e^{-\img p_\mu x^\mu} \pa_0^2 \phi(x) - \phi(x) (\bs{\nabla}^2 - m^2) e^{-\img p_\mu x^\mu} \right]
      \end{split}
    \end{equation*}
    where the last line follows from $ \pa_0^2 e^{-\img p_\mu x^\mu} = - p_0^2 e^{-\img p_\mu x^\mu} = (\ve{p}^2 - p^2) e^{-\img p_\mu x^\mu} = (\bs{\nabla}^2 - m^2) e^{-\img p_\mu x^\mu} $. In order to perform integration by parts, note that initial and final particle states are understood to be convoluted to form wave-packets, which are localized in space, while $ \phi(x) $ is not localized in time; hence, the second term can be integrated by parts twice, resulting in:
    \begin{equation*}
      \sqrt{2E_\ve{p}} ({a_\ve{p}^\text{in}}\dg - {a_\ve{p}^\text{out}}\dg) = \frac{\img}{\sqrt{Z}} \int \dd^4x\, e^{-\img p_\mu x^\mu} (\pa_0^2 - \bs{\nabla}^2 + m^2) \phi(x)
    \end{equation*}
    The other operator is found analogously.
  \end{proof}
\end{proofbox}
...
\begin{definition}{Bosonic chronological product}{}
  Given two bosonic fields $ f(x) $ and $ g(x) $, their \bcdef{chronological product} is defined as:
  \begin{equation}
    \begin{split}
...
\begin{theorem}{LSZ reduction formula for scalar fields}{lsz-scalar}
  The amplitude for the process $ \ket{\ve{k}_1 , \dots , \ve{k}_n; -\infty} \rightarrow \ket{\ve{p}_1 , \dots , \ve{p}_m; +\infty} $, with $ \ve{k}_i \neq \ve{p}_j \,\,\forall i = 1, \dots, n , j = 1, \dots, m $, is given by the \bcth{Lehmann--Symanzik--Zimmermann formula}:
  \begin{multline}
    \braket{\ve{p}_1 , \dots , \ve{p}_m ; +\infty | \ve{k}_1 , \dots , \ve{k}_n ; -\infty} = \\
    = \prod_{i = 1}^n \frac{k_i^2 - m^2}{\img \sqrt{Z}} \int \dd^4x_i\, e^{-\img {k_i}_\mu {x_i}^\mu} \prod_{j = 1}^m \frac{p_j^2 - m^2}{\img \sqrt{Z}} \int \dd^4y_j\, e^{+\img {p_j}_\mu {y_j}^\mu} \times \\
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        \braket{\ve{p}_1,\dots,\ve{p}_m;+\infty | \ve{k}_1,\dots,\ve{k}_n;-\infty}
        & = \frac{\img}{\sqrt{Z}} \int \dd^4x_1\, e^{-\img {k_1}_\mu {x_1}^\mu} (\Box_{x_1} + m^2) \times \\
    ...
    \begin{equation*}
      \begin{split}
        ...
        & \qquad = \frac{\img}{\sqrt{Z}} \int \dd^4y_1\, e^{+\img {p_1}_\mu {y_1}^\mu} (\Box_{y_1} + m^2) \braket{\ve{p}_2,\dots,\ve{p}_m;+\infty | \tempord\{\phi(y_1) \phi(x_1)\} | \ve{k}_2,\dots,\ve{k}_n;-\infty}
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        & \braket{\ve{p}_1,\dots\ve{p}_m;+\infty | \ve{k}_1,\dots,\ve{k}_n;-\infty} = \prod_{i = 1}^n \frac{\img}{\sqrt{Z}} \int \dd^4x_i\, e^{-\img {k_i}_\mu {x_i}^\mu} \prod_{j = 1}^m \frac{\img}{\sqrt{Z}} \int \dd^4y_j\, e^{+\img {p_j}_\mu {x_j}^\mu} \times \\
        & \qquad \qquad \qquad \qquad \qquad \quad \ \ \times (\Box_{x_i} + m^2) (\Box_{y_j} + m^2) \braket{0 | \tempord\{\phi(x_1) \dots \phi(x_n) \phi(y_1) \dots \phi(y_m)\} | 0}
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      G(x_1, \dots, x_N) = \prod_{i = 1}^N \int \frac{\dd^4\xi_i}{(2\pi)^4} e^{\img {\xi_i}_\mu {x_i}^\mu} \tilde{G}(\xi_1, \dots, \xi_N)
    \end{equation*}
    Then:
    \begin{equation*}
      (\Box_{x_j} + m^2) G(x_1, \dots, x_N) = - \prod_{i = 1}^N \int \frac{\dd^4\xi_i}{(2\pi)^4} e^{\img {\xi_i}_\mu {x_i}^\mu} (\xi_j^2 - m^2) \tilde{G}(\xi_1, \dots, \xi_N)
    \end{equation*}
    Substituting into the above expression:
    \begin{equation*}
      \begin{split}
        & \prod_{i = 1}^N \frac{\img}{\sqrt{Z}} \int \dd^4x_i e^{-\img {k_i}_\mu {x_i}^\mu} (\Box_{x_i} + m^2) G(x_1, \dots, x_N) = \\
        & \qquad \qquad = - \prod_{i = 1}^N \frac{\img}{\sqrt{Z}} \int \frac{\dd^4x_i \dd^4\xi_i}{(2\pi)^4} e^{\img (\xi_i - k_i)_\mu x^\mu} (\xi_i^2 - m^2) \tilde{G}(\xi_1, \dots, \xi_N) \\
        & \qquad \qquad = \prod_{i = 1}^N \frac{1}{\img \sqrt{Z}} \int \dd^4\xi_i\, \delta^{(4)}(\xi_i - k_i) (\xi_i^2 - m^2) \tilde{G}(\xi_1, \dots, \xi_N) \\
        & \qquad \qquad = \prod_{i = 1}^N \frac{k_i^2 - m^2}{\img \sqrt{Z}} \tilde{G}(k_1, \dots, k_N) = \prod_{i = 1}^N \frac{k_i^2 - m^2}{\img \sqrt{Z}} \int \dd^4x_i\, e^{-\img {k_i}_\mu {x_i}^\mu} G(x_1, \dots, x_N)
      \end{split}
    \end{equation*}
...
\begin{equation}
  \sqrt{2\omega_\ve{p}} {a_{\ve{p},\lambda}^\text{in,out}}\dg = -\img {\epsilon^\mu}^*(\ve{p},\lambda) \int \dd^3x\, e^{-\img p_\mu x^\mu} \smlra{\pa_0} A^\text{in,out}_\mu(x)
\end{equation}

\begin{lemma}[before upper = {\tcbtitle}]{}{}
  \begin{equation}
    \sqrt{2\omega_\ve{p}} ({a_{\ve{p},\lambda}^\text{in}}\dg - {a_{\ve{p},\lambda}^\text{out}}\dg) = \frac{\img}{\sqrt{Z}} {\epsilon^\mu}^*(\ve{p},\lambda) \int \dd^4x\, e^{-\img p_\mu x^\mu} \Box A_\mu(x)
  \end{equation}
  \begin{equation}
    \sqrt{2\omega_\ve{p}} (a_{\ve{p},\lambda}^\text{out} - a_{\ve{p},\lambda}^\text{in}) = \frac{\img}{\sqrt{Z}} \epsilon^\mu(\ve{p},\lambda) \int \dd^4x\, e^{-\img p_\mu x^\mu} \Box A_\mu(x)
  \end{equation}
\end{lemma}
  ...
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        ...
        & = - \frac{\img}{\sqrt{Z}} {\epsilon^{\mu}}^*(\ve{p},\lambda) \int \dd^4x\, \pa_0 \left[ e^{-\img p_\mu x^\mu} \smlra{\pa_0} A_\mu(x) \right] \\
        & = - \frac{\img}{\sqrt{Z}} {\epsilon^{\mu}}^*(\ve{p},\lambda) \int \dd^4x \left[ e^{-\img p_\mu x^\mu} \pa_0^2 A_\mu(x) - A_\mu(x) \pa_0^2 e^{-\img p_\mu x^\mu} \right] \\
        & = - \frac{\img}{\sqrt{Z}} {\epsilon^{\mu}}^*(\ve{p},\lambda) \int \dd^4x \left[ e^{-\img p_\mu x^\mu} \pa_0^2 A_\mu(x) - A_\mu(x) \bs{\nabla}^2 e^{-\img p_\mu x^\mu} \right]
      \end{split}
    \end{equation*}
    where the last line follows from $ \pa_0^2 e^{-\img p_\mu x^\mu} = - p_0^2 e^{-\img p_\mu x^\mu} = (\ve{p} - p^2) e^{-\img p_\mu x^\mu} = \bs{\nabla}^2 e^{-\img p_\mu x^\mu} $. By the same observation made in the proof of \lref{lemma:scal-in-out-rel}, the second term is integrated by parts twice, resulting in:
    \begin{equation*}
      \sqrt{2\omega_\ve{p}} ({a_{\ve{p},\lambda}^\text{in}}\dg - {a_{\ve{p},\lambda}^\text{out}}\dg) = \frac{\img}{\sqrt{Z}} {\epsilon^\mu}^*(\ve{p},\lambda) \int \dd^4x\, e^{-\img p_\mu x^\mu} (\pa_0^2 - \bs{\nabla}^2) A_\mu(x)
    \end{equation*}
...
\begin{multline}
  \braket{\ve{k}_1 , \dots , \ve{k}_n | \img T | \ve{p}_1 , \dots , \ve{p}_m} \\
  = \prod_{i = 1}^n \frac{k_i^2}{\img \sqrt{Z}} \int \dd^4x_i\, e^{-\img {k_i}_\mu {x_i}^\mu} \sum_{\lambda_i = 1,2} {\epsilon^{\mu_i}}^*(\ve{k}_i,\lambda_i) \prod_{j = 1}^m \int \dd^4y_j\, e^{+\img {p_j}_\mu {x_j}^\mu} \sum_{\sigma_j = 1,2} \epsilon^{\nu_j}(\ve{p}_j,\sigma_j) \times \\
...
\begin{equation}
  \sqrt{2E_\ve{p}} {a_{\ve{p},s}^\text{in,out}}\dg = \frac{1}{\sqrt{Z}} \lim_{t \rightarrow \mp \infty} \int \dd^3x\, e^{-\img p_\mu x^\mu} \bar{\Psi}(x) \gamma^0 u^s(p) = \int \dd^3x\, e^{-\img p_\mu x^\mu} \bar{\Psi}_\text{in,out}(x) \gamma^0 u^s(p)
\end{equation}
\begin{equation}
  \sqrt{2E_\ve{p}} {b_{\ve{p},s}^\text{in,out}}\dg= \frac{1}{\sqrt{Z}} \lim_{t \rightarrow \mp \infty} \int \dd^3x\, e^{\img p_\mu x^\mu} \bar{v}^s(p) \gamma^0 \Psi(x) = \int \dd^3x\, e^{\img p_\mu x^\mu} \bar{v}^s(p) \gamma^0 \Psi_\text{in,out}(x) 
\end{equation}

\begin{lemma}[before upper = {\tcbtitle}]{}{}
  \begin{equation}
    \sqrt{2E_\ve{p}} ({a_{\ve{p},s}^\text{in}}\dg - {a_{\ve{p},s}^\text{out}}\dg) = \frac{\img}{\sqrt{Z}} \int \dd^4x\, \bar{\Psi}(x) ( \img \smla{\slashed{\pa}} + m ) u^s(p) e^{-\img p_\mu x^\mu}
  \end{equation}
  \begin{equation}
    \sqrt{2E_\ve{p}} ({a_{\ve{p},s}^\text{out}} - {a_{\ve{p},s}^\text{in}}) = - \frac{\img}{\sqrt{Z}} \int \dd^4x\, e^{\img p_\mu x^\mu} \bar{u}^s(p) ( \img \smra{\slashed{\pa}} - m ) \Psi(x)
  \end{equation}
  \begin{equation}
    \sqrt{2E_\ve{p}} ({b_{\ve{p},s}^\text{in}}\dg - {b_{\ve{p},s}^\text{out}}\dg) = \frac{\img}{\sqrt{Z}} \int \dd^4x\, e^{-\img p_\mu x^\mu} \bar{v}^s(p) ( \img \smra{\slashed{\pa}} - m ) \Psi(x)
  \end{equation}
  \begin{equation}
    \sqrt{2E_\ve{p}} ({b_{\ve{p},s}^\text{out}} - {b_{\ve{p},s}^\text{in}}) = - \frac{\img}{\sqrt{Z}} \int \dd^4x\, \bar{\Psi}(x) ( \img \smla{\slashed{\pa}} + m ) v^s(p) e^{\img p_\mu x^\mu}
  \end{equation}
\end{lemma}
  ...
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        ...
        & = - \frac{1}{\sqrt{Z}} \int \dd^4x\, \pa_0 \left[ e^{-\img p_\mu x^\mu} \bar{\Psi}(x) \gamma^0 u^s(p) \right] \\
        & = - \frac{1}{\sqrt{Z}} \int \dd^4x\, \bar{\Psi}(x) \left[ -\img \gamma ^0 p_0 + \gamma^0 \smla{\pa}_0 \right] u^s(p) e^{-\img p_\mu x^\mu}
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        \sqrt{2E_\ve{p}} ({a_{\ve{p},s}^\text{in}}\dg - {a_{\ve{p},s}^\text{out}}\dg)
        & = - \frac{1}{\sqrt{Z}} \int \dd^4x\, \bar{\Psi}(x) \left[ \img \gamma ^k p_k - \img m + \gamma^0 \smla{\pa}_0 \right] u^s(p) e^{-\img p_\mu x^\mu} \\
        & = - \frac{1}{\sqrt{Z}} \int \dd^4x\, \bar{\Psi}(x) \left[ \gamma^0 \smla{\pa}_0 - \gamma^k \smra{\pa}_k - \img m \right] u^s(p) e^{-\img p_\mu x^\mu}
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        \sqrt{2E_\ve{p}} ({a_{\ve{p},s}^\text{in}}\dg - {a_{\ve{p},s}^\text{out}}\dg)
        & = - \frac{1}{\sqrt{Z}} \int \dd^4x\, \bar{\Psi}(x) \left[ \gamma^0 \smla{\pa}_0 + \gamma^k \smla{\pa}_k - \img m \right] u^s(p) e^{-\img p_\mu x^\mu} \\
        & = \frac{i}{\sqrt{Z}} \int \dd^4x\, \bar{\Psi}(x) \left[ \img \smla{\slashed{\pa}} + m \right] u^s(p) e^{-\img p_\mu x^\mu}
      \end{split}
    \end{equation*}
...
\begin{equation}
  \braket{\beta_\text{fin} ; + \infty | \ve{k},s ; -\infty} \mapsto \frac{\img}{\sqrt{Z}} \int \dd^4x \sum_{a = 1}^{4} \braket{\beta_\text{fin} | [\bar{\Psi}(x)]_a | 0} [( \img \smla{\slashed{\pa}} + m ) u^s(k)]_a e^{-\img k_\mu x^\mu}
\end{equation}
\begin{equation}
  \braket{\beta_\text{fin} ; + \infty | \tilde{\ve{k}},\tilde{s} ; -\infty} \mapsto \frac{i}{\sqrt{Z}} \int \dd^4\tilde{x} \sum_{a = 1}^{4} e^{-i \tilde{k}_\mu \tilde{x}^\mu} [\bar{v}^{\tilde{s}}(\tilde{k})( \img \smra{\slashed{\pa}} - m )]_a \braket{\beta_\text{fin} | [\Psi(\tilde{x})]_a | 0}
\end{equation}
\begin{equation}
  \braket{\ve{p},s ; +\infty | \alpha_\text{in} ; -\infty} \mapsto - \frac{\img}{\sqrt{Z}} \int \dd^4y \sum_{a = 1}^{4} e^{\img p_\mu y^\mu} [\bar{u}^s(p) ( \img \smra{\slashed{\pa}} - m )]_a \braket{0 | [\Psi(y)]_a | \alpha_\text{in}}
\end{equation}
\begin{equation}
  \braket{\tilde{\ve{p}},\tilde{s} ; +\infty | \alpha_\text{in} ; -\infty} \mapsto - \frac{\img}{\sqrt{Z}} \int \dd^4\tilde{y} \sum_{a = 1}^{4} \braket{0 | [\bar{\Psi}(\tilde{y})]_a | \alpha_\text{in}} [( \img \smla{\slashed{\pa}} + m ) v^{\tilde{s}}(\tilde{p})]_a e^{\img \tilde{p}_\mu \tilde{y}^\mu}
\end{equation}
In general, the final ``reduced" amplitude formula will contain a $ (n_1 + n_2 + m_1 + m_2) $-point Green function like (omitting spinor indices):
\begin{equation*}
...
\begin{equation}
  \phi_I(t,\ve{x}) \defeq e^{\img H_0 (t-t_0)} \phi(t_0, \ve{x}) e^{-\img H_0 (t-t_0)}
\end{equation}
...
\begin{equation}
  \phi_I(t,\ve{x}) = \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \left[ a_\ve{p} e^{-\img p_\mu x^\mu} + a_\ve{p}\dg e^{\img p_\mu x^\mu} \right]_{p^0 = E_\ve{p} ,\, x^0 = t - t_0}
\end{equation}
...
\begin{proposition}{Interaction picture}{}
  ...
  \begin{equation}
    \phi(t,\ve{x}) = \mt{U}\dg(t,t_0) \phi_I \mt{U}(t,t_0)
    \label{eq:int-heis-pic}
  \end{equation}
  with:
  \begin{equation}
    \mt{U}(t,t_0) \equiv e^{\img H_0 (t-t_0)} e^{-\img H (t-t_0)}
  \end{equation}
\end{proposition}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        \phi(t,\ve{x})
        & = e^{\img H (t-t_0)} \phi(t_0,\ve{x}) e^{-\img H (t-t_0)} \\
        & = e^{\img H (t-t_0)} e^{-\img H_0 (t-t_0)} \left[ e^{\img H_0 (t-t_0)} \phi(t_0,\ve{x}) e^{-\img H_0 (t-t_0)} \right] e^{\img H_0 (t-t_0)} e^{-\img H (t-t_0)} \\
        & = e^{\img H (t-t_0)} e^{-\img H_0 (t-t_0)} \phi_I(t,\ve{x}) e^{\img H_0 (t-t_0)} e^{-\img H (t-t_0)} \equiv \mt{U}\dg(t,t_0) \phi_I(t,\ve{x}) \mt{U}(t,t_0)
      \end{split}
    \end{equation*}
...
Note that, since $ [H_0,H_\text{int}] \neq 0 $ in general, the two exponentials cannot be combined trivially (the Baker-Campbell-Hausdorff formula should be used instead).

\begin{proposition}{Time evolution operator}
  The time evolution operator is:
  \begin{equation}
    \mt{U}(t,t_0) = \tempord \exp \left[ -\img \int_{t_0}^t \dd\tau\, H_I(\tau) \right]
  \end{equation}
  where:
  \begin{equation}
    H_I(t) \equiv e^{\img H_0 (t-t_0)} H_\text{int} e^{-\img H_0 (t-t_0)}
  \end{equation}
\end{proposition}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        \img \frac{\pa}{\pa t} \mt{U}(t,t_0)
        & = e^{\img H_0 (t-t_0)} (H - H_0) e^{-\img H (t-t_0)} = e^{\img H_0 (t-t_0)} H_\text{int} e^{-\img H (t-t_0)} \\
        & = e^{\img H_0 (t-t_0)} H_\text{int} e^{-\img H_0 (t-t_0)} e^{\img H_0 (t-t_0)} e^{-\img H (t-t_0)} \equiv H_I(t) \mt{U}(t,t_0)
      \end{split}
    \end{equation*}
    The solution to this equation which satisfies the initial condition $ \mt{U}(t_0,t_0) = 1 $ is unique:
    \begin{equation*}
      \begin{split}
        \mt{U}(t,t_0)
        & = \tempord \exp \left[ -\img \int_{t_0}^t \dd\tau\, H_I(\tau) \right] = \sum_{n = 0}^{\infty} \frac{(-\img)^n}{n!} \int_{[t_0,t]^n} \dd t_1 \dots \dd t_n\, \tempord\{H_I(t_1) \dots H_I(t_n)\} \\
        & = \sum_{n = 0}^{\infty} (-\img)^n \int_{t_0}^t \dd t_1 \int_{t_0}^{t_1} \dd t_2 \dots \int_{t_0}^{t_{n-1}} \dd t_n\, H_I(t_1) \dots H_I(t_n)
      \end{split}
    \end{equation*}
    It is in fact clear that:
    \begin{equation*}
      \frac{\pa}{\pa t} \mt{U}(t,t_0) = \sum_{n = 0}^{\infty} (-\img)^n \int_{t_0}^{t} \dd t_2 \dots \int_{t_0}^{t_{n-1}} \dd t_n\, H_I(t) H_I(t_2) \dots H_I(t_n) = -\img H_I(t) \mt{U}(t,t_0)
    \end{equation*}
...
\begin{lemma}[before upper = {\tcbtitle}]{}{time-evol-func}
  \begin{equation}
    \mt{U}(t_1,t_0) \mt{U}(t_0,t_2) = \mt{U}(t_1,t_2)
  \end{equation}
\end{lemma}
...
\begin{proofbox}
  \begin{proof}
    Observe that:
    \begin{equation*}
      \img \frac{\pa}{\pa t} [\mt{U}(t,t_0) \mt{U}(t_0,t_2)] = \left[ \img \frac{\pa}{\pa t} \mt{U}(t,t_0) \right] \mt{U}(t_0,t_2) = H_I(t) \mt{U}(t,t_0) \mt{U}(t_0,t_2)
    \end{equation*}
    The boundary condition now reads $ [\mt{U}(t,t_0) \mt{U}(t_0,t_2)]_{t = t_0} = \mt{U}(t_0,t_2) $, and the unique solution for this boundary condition is:
    \begin{equation*}
      \mt{U}(t,t_0) \mt{U}(t_0,t_2) = \tempord \exp \left[ -\img \int_{t_0}^t \dd\tau\, H_I(\tau) \right]
    \end{equation*}
    which is precisely $ \mt{U}(t,t_2) $.
  \end{proof}
\end{proofbox}
...
\begin{theorem}{Correlation functions}{}
  ...
  \begin{equation}
    \braket{0 | \tempord\{\phi(x_1) \dots \phi(x_n)\} | 0} = \frac{\braket{0 | \tempord\{\phi_I(x_1) \dots \phi_I(x_n) \exp \left[ -\img \int \dd^4x\, \ham_I \right]\} | 0}}{\braket{0 | \tempord\{\exp \left[ -\img \int \dd^4x\, \ham_I \right]\} |0}}
  ...
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        ...
        & = \braket{0 | \mt{U}\dg(t_1,t_0) \phi_I(x_1) \mt{U}(t_1,t_0) \mt{U}\dg(t_2,t_0) \dots \mt{U}\dg(t_n,t_0) \phi_I(x_n) \mt{U}(t_n,t_0) | 0} \\
        & = \braket{0 | \mt{U}\dg(t_1,t_0) \phi_I(x_1) \mt{U}(t_1,t_2) \dots \mt{U}(t_{n-1},t_n) \phi_I(x_n) \mt{U}(t_n,t_0) | 0}
      \end{split}
    \end{equation*}
    Consider $ t \in \R : t \gg t_1 > \dots > t_n \gg -t $, so that $ \mt{U}(t_n,t_0) = \mt{U}(t_n,-t) \mt{U}(-t,t_0) $ and $ \mt{U}\dg(t_1,t_0) = \mt{U}\dg(t,t_0) \mt{U}(t,t_1) $. Therefore:
    \begin{equation*}
      \begin{split}
        \braket{0 | \phi(x_1) \dots \phi(x_n) | 0}
        & = \bra{0} \mt{U}\dg(t,t_0) [\mt{U}(t,t_1) \phi_I(x_1) \mt{U}(t_1,t_2) \phi_I(x_2) \mt{U}(t_2,t_3) \dots \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \dots \mt{U}(t_{n-1},t_n) \phi_I(x_n) \mt{U}(t_n,-t)] \mt{U}(-t,t_0) \ket{0}
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        [\dots]
        & = \tempord\{\phi_I(x_1) \dots \phi_I(x_n) \mt{U}(t,t_1) \mt{U}(t_1,t_2) \dots \mt{U}(t_n,-t)\} \\
        & = \tempord\bigg\{ \phi_I(x_1) \dots \phi_I(x_n) \exp \left[ -\img \int_{-t}^t \dd\tau\, H_I(\tau) \right]\bigg\}
      \end{split}
    \end{equation*}
    These considerations hold for arbitrary $ t_0 $, so it can be set $ t_0 = -t \rightarrow -\infty $. Then:
    \begin{equation*}
      \braket{0 | \tempord\{\phi(x_1) \dots \phi(x_n)\} | 0} = \braket{0 | \mt{U}\dg(+\infty,-\infty) \tempord\bigg\{ \phi_I(x_1) \dots \phi_I(x_n) \exp \left[ -\img \int \dd^4x\, \ham_I \right] \bigg\} | 0}
    \end{equation*}
    Note that $ \bra{0} \mt{U}\dg(\infty,-\infty) $ is the Hermitian conjugate of $ \mt{U}(\infty,-\infty) \ket{0} $, i.e. the state obtained evolving in time the vacuum state. As it was already assumed, the initial-state vacuum coincides physically to the final-state vacuum, i.e.:
    \begin{equation*}
      \mt{U}(\infty,-\infty) \ket{0} = e^{\img \alpha} \ket{0}
      \quad \implies \quad
      e^{-\img \alpha} = \left( \braket{0 | \tempord\bigg\{ \exp \left[ -\img \int \dd^4x\, \ham_I \right] \bigg\} | 0} \right)^{-1}
    \end{equation*}
    Finally:
    \begin{equation*}
    \braket{0 | \tempord\{\phi(x_1) \dots \phi(x_n)\} | 0} = \frac{\braket{0 | \tempord\{\phi_I(x_1) \dots \phi_I(x_n) \exp \left[ -\img \int \dd^4x\, \ham_I \right]\} | 0}}{\braket{0 | \tempord\{\exp \left[ -\img \int \dd^4x\, \ham_I \right]\} |0}}
...
\begin{example}{$ \phi^4 $ potential}{}
  ...
  \begin{equation*}
    \begin{split}
      \ham_I = \frac{\lambda}{4!} e^{\img H_0 (t-t_0)} \phi^4 e^{-\img H_0 (t-t_0)} = \frac{\lambda}{4!} \left[ e^{\img H_0 (t-t_0)} \phi e^{-\img H_0 (t-t_0)} \right]^4 = \frac{\lambda}{4!} \phi_I^4
    \end{split}
  \end{equation*}
\end{example}
...
\begin{theorem}{Feynman propagator}{feynman-prop}
  ...
  \begin{equation}
    \fpr(x-y) \defeq \braket{0 | \tempord\{\phi_I(x) \phi_I(y)\} | 0} = \int \frac{\dd^4p}{(2\pi)^4} \frac{\img}{p^2 - m^2 + \img \epsilon} e^{-\img p_\mu (x - y)^\mu}
    \label{eq:feynm-prop}
  \end{equation}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \phi_I^+(x) \equiv \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} a_\ve{p} e^{-\img p_\mu x^\mu}
      \qquad \qquad
      \phi_I^-(x) \equiv \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} a_\ve{p}\dg e^{\img p_\mu x^\mu}
    \end{equation*}
    ...
    \begin{equation*}
      ...
      \end{split}
    \end{equation*}
    Similarly, for $ y^0 > x^0 $ one has $ \tempord\{\phi_I(x) \phi_I(y)\} = \normord\{\phi_I(x) \phi_I(y)\} + [\phi^+(y) , \phi^-(x)] $.
    Therefore, in general:
    \begin{equation*}
      \begin{split}
        \tempord\{\phi_I(x) \phi_I(y)\}
        & = \normord\{\phi_I(x) \phi_I(y)\} + \theta(x^0 - y^0) [\phi_I^+(x) , \phi_I^-(y)] + \theta(y^0 - x^0) [\phi_I^+(y) , \phi_I^-(x)] \\
        & \equiv \normord\{\phi_I(x) \phi_I(y)\} + \fpr(x-y)
      \end{split}
    \end{equation*}
    Now, observe that $ \braket{0 | \normord\{\phi_I(x) \phi_I(y)\} | 0} = 0 $, as there is always either an annihilation operator acting on $ \ket{0} $ or a creation operator acting on $ \bra{0} $. On the other hand, $ \fpr(x-y) \in \C $, as $ [a_\ve{p} , a\dg_\ve{q}] \in \C $, therefore $ \braket{0 | \fpr(x-y) | 0} = \fpr(x-y) \braket{0 | 0} = \fpr(x-y) $. There only remains to compute the commutators:
    \begin{equation*}
      \begin{split}
        \fpr(x-y)
        & = \int \frac{\dd^3p \dd^3q}{(2\pi)^6 \sqrt{4E_\ve{p}E_\ve{q}}} \big[ \theta(x^0 - y^0) [a_\ve{p} , a\dg_\ve{q}] e^{-\img p_\mu x^\mu + \img q_\mu y^\mu} + \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \ \, + \theta(y^0 - x^0) [a_\ve{p} , a\dg_\ve{q}] e^{-\img p_\mu y^\mu + \img q_\mu x^\mu} \big] \\
        & = \int \frac{\dd^3p \dd^3q}{(2\pi)^3 \sqrt{4E_\ve{p}E_\ve{q}}} \delta^{(3)}(\ve{p} - \ve{q}) \left[ \theta(x^0 - y^0) e^{-\img p_\mu x^\mu + \img q_\mu y^\mu} + \theta(y^0 - x^0) e^{-\img p_\mu y^\mu + \img q_\mu x^\mu} \right] \\
        & = \int \frac{\dd^3p}{(2\pi)^3 2E_\ve{p}} \left[ \theta(x^0 - y^0) e^{-\img p_\mu (x-y)^\mu} + \theta(y^0 - x^0) e^{\img p_\mu (x-y)^\mu} \right]
      \end{split}
    \end{equation*}
    To show that this is equivalent to the thesis, note that \eref{eq:feynm-prop} can be rewritten as:
    \begin{equation*}
      \Delta(x-y) = \int \frac{\dd^3p}{(2\pi)^3} e^{i \ve{p} \cdot (\ve{x} - \ve{y})} \int_\R \frac{\dd p^0}{2\pi} \frac{\img}{(p^0)^2 - E_\ve{p}^2 + \img \epsilon} e^{-\img p^0 (x^0 - y^0)}
    \end{equation*}
    as $ E_\ve{p} = + \sqrt{\ve{p}^2 + m^2} $. The integral in $ \dd p^0 $ can be computed in the complex $ p^0 $-plane\footnote{As the integrand is $ \sim (p^0)^{-2} $, the contribution of the curved part of a semicircular contour vanishes, only leaving the integral over the real axis.}: the $ \img \epsilon $-prescription slightly displaces the poles from the real axis\footnote{The poles are $ p^0 = \pm \sqrt{E_\ve{p}^2 - \img \epsilon} = \pm \left( E_\ve{p} - \frac{\img \epsilon}{2E_\ve{p}} \right) + \smo(\epsilon^2) $.}, and in particular that in $ p^0 = + E_\ve{p} $ is slightly below it while that in $ p^0 = - E_\ve{p} $ is slightly above it. If $ x^0 - y^0 > 0 $, choose a semicircular (clockwise) contour in the lower-half plane, so that only the $ p^0 = E_\ve{p} $ singularity is enclosed:
    \begin{equation*}
      \Delta(x-y)\vert_{x^0 > y^0} = \int \frac{\dd^3p}{(2\pi)^3} e^{\img \ve{p} \cdot (\ve{x} - \ve{y})} \frac{\img}{2\pi} \left[ (-2\pi \img) \frac{e^{-\img E_\ve{p} (x^0 - y^0)}}{2E_\ve{p}} \right] = \int \frac{\dd^3p}{(2\pi)^3 2E_\ve{p}} e^{-\img p_\mu (x-y)^\mu}
    \end{equation*}
    If $ x^0 - y^0 < 0 $, choose a semicircular (counter-clockwise) contour in the upper-half plane:
    \begin{equation*}
      \Delta(x-y)\vert_{y^0 > x^0} = \int \frac{\dd^3p}{(2\pi)^3} e^{\img \ve{p} \cdot (\ve{x} - \ve{y})} \frac{\img}{2\pi} \left[ (2\pi \img) \frac{e^{\img E_\ve{p} (x^0 - y^0)}}{-2E_\ve{p}} \right] = \int \frac{\dd^3p}{(2\pi)^3 2E_\ve{p}} e^{\img p_\mu (x-y)^\mu}
    \end{equation*}
...
\begin{theorem}{Dirac propagator}{dirac-prop}
  ...
  \begin{equation}
    \dpr(x - y) \defeq \braket{0 | \tempord\{\Psi_I(x) \bar{\Psi}_I(y)\} | 0} = \int \frac{\dd^4p}{(2\pi)^4} \frac{\img (\slashed{p} + m)}{p^2 - m^2 + \img \epsilon} e^{-\img p_\mu (x - y)^\mu}
    \label{eq:dirac-prop}
  \end{equation}
\end{theorem}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{align*}
      \Psi_I^+(x) &= \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} a_{\ve{p},s} u^s(p) e^{-\img p_\mu x^\mu}
      \quad
      \Psi_I^-(x) &= \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} b_{\ve{p},s}\dg v^s(p) e^{\img p_\mu x^\mu}
      \\
      \bar{\Psi}_I^+(x) &= \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} b_{\ve{p},s} \bar{v}^s(p) e^{-\img p_\mu x^\mu}
      \quad
      \bar{\Psi}_I^-(x) &= \int \frac{\dd^3p}{(2\pi)^3 \sqrt{2E_\ve{p}}} \sum_{s = 1,2} a_{\ve{p},s}\dg \bar{u}^s(p) e^{\img p_\mu x^\mu}
    \end{align*}
    ...
    \begin{equation*}
      \begin{split}
        ...
        & \qquad \qquad \ \ = \Psi_I^+(x) \bar{\Psi}_I^+(y) - \bar{\Psi}_I^-(y) \Psi_I^+(x) + \Psi_I^-(x) \bar{\Psi}_I^+(y) + \Psi_I^-(x) \bar{\Psi}_I^-(y) + \{\Psi_I^+(x) , \bar{\Psi}_I^-(y)\} \\
    ...
    \begin{equation*}
      \begin{split}
        ...
        & \qquad \qquad \ \ = \Psi_I^+(x) \bar{\Psi}_I^+(y) - \bar{\Psi}_I^-(y) \Psi_I^+(x) + \Psi_I^-(x) \bar{\Psi}_I^+(y) + \Psi_I^-(x) \bar{\Psi}_I^-(y) - \{\bar{\Psi}_I^+(y) , \Psi_I^-(x)\} \\
    ...
    \begin{equation*}
      \begin{split}
        \tempord\{\Psi_I(x) \bar{\Psi}_I(y)\} \hspace{-0.1em}
        & = \normord\{\Psi_I(x) \bar{\Psi}_I(y)\} \hspace{-0.1em} + \theta(x^0 - y^0) \{\Psi_I^+(x) , \bar{\Psi}_I^-(y)\} - \theta(y^0 - x^0) \{\bar{\Psi}_I^+(y) , \Psi_I^-(x)\} \\
        & = \normord\{\Psi_I(x) \bar{\Psi}_I(y)\} \hspace{-0.1em} + \dpr(x - y)
      \end{split}
    \end{equation*}
    By the same observations as in the previous proof $ \braket{0 | \tempord\{\Psi_I(x) \bar{\Psi}_I(y)\} | 0} = \dpr(x - y) $, so explicitly computing the anti-commutators:
    \begin{equation*}
      \begin{split}
        \dpr(x - y)
        & = \int \frac{\dd^3p \dd^3q}{(2\pi)^6 \sqrt{4E_\ve{p}E_\ve{q}}} \sum_{s = 1,2} \sum_{r = 1,2} \big[ \theta(x^0 - y^0) \{a_{\ve{p},s} , a_{\ve{q},r}\dg\} u^s(p) \bar{u}^r(q) e^{-\img p_\mu x^\mu + \img q_\mu y^\mu} + \\
        & \qquad \qquad \qquad \qquad \qquad \qquad - \theta(y^0 - x^0) \{b_{\ve{p},s} , b_{\ve{q},r}\dg\} v^r(q) \bar{v}^s(p) e^{-\img p_\mu x^\mu + \img q_\mu y^\mu} \big] \\
        & = \int \frac{\dd^3p \dd^3q}{(2\pi)^3 \sqrt{4E_\ve{p}E_\ve{q}}} \sum_{s = 1,2} \sum_{r = 1,2} \delta^{(3)}(\ve{p} - \ve{q}) \delta_{sr} \big[ \theta(x^0 - y^0) u^s(p) \bar{u}^r(q) e^{-\img p_\mu y^\mu + \img q_\mu x^\mu} + \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad \qquad - \theta(y^0 - x^0) v^r(q) \bar{v}^s(p) e^{-\img p_\mu x^\mu + \img q_\mu y^\mu} \big] \\
        & \hspace{-1.5em} = \int \frac{\dd^3p}{(2\pi)^3 2E_\ve{p}} \sum_{s = 1,2} \left[ \theta(x^0 - y^0) u^s(p) \bar{u}^s(p) e^{-\img p_\mu (x-y)^\mu} - \theta(y^0 - x^0) v^s(p) \bar{v}^s(p) e^{\img p_\mu (x-y)^\mu} \right]
      \end{split}
    \end{equation*}
    Recalling \eref{eq:spinor-sums}:
    \begin{equation*}
      \dpr(x - y) = \int \frac{\dd^3p}{(2\pi)^3 2E_\ve{p}} \left[ \theta(x^0 - y^0) (\slashed{p} + m) e^{-\img p_\mu (x-y)^\mu} - \theta(y^0 - x^0) (\slashed{p} - m) e^{\img p_\mu (x-y)^\mu} \right]
    \end{equation*}
    ...
    \begin{equation*}
      \dpr(x - y) = \int \frac{\dd^3p}{(2\pi)^3} e^{i \ve{p} \cdot (\ve{x} - \ve{y})} \int \frac{\dd p^0}{2\pi} \frac{\img (p^0 \gamma^0 - \ve{p} \cdot \bs{\gamma} + m)}{(p^0)^2 - E_\ve{p}^2 + \img \epsilon} e^{-\img p^0 (x^0 - y^0)}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        \dpr(x - y)\vert_{x^0 > y^0} \hspace{-0.1em}
        & = \int \frac{\dd^3p}{(2\pi)^3} e^{\img \ve{p} \cdot (\ve{x} - \ve{y})} \frac{\img}{2\pi} \left[ (-2\pi \img) \frac{E_\ve{p} \gamma^0 - \ve{p} \cdot \bs{\gamma} + m}{2E_\ve{p}} e^{-\img E_\ve{p} (x^0 - y^0)} \right] \\
        & = \int \frac{\dd^3p}{(2\pi)^3 2E_\ve{p}} e^{\img p_\mu \cdot (x-y)^\mu} (E_\ve{p} \gamma^0 \hspace{-0.1em} - \ve{p} \cdot \bs{\gamma} + m) = \hspace{-0.1em} \int \hspace{-0.1em} \frac{\dd^3p}{(2\pi)^3 2E_\ve{p}} e^{\img p_\mu \cdot (x-y)^\mu} (\slashed{p} + m)
      \end{split}
    \end{equation*}
    If instead $ y^0 > x^0 $, chose a semicircular (counter-clockwise) contour in the upper-half plane:
    \begin{equation*}
      \begin{split}
        \dpr(x - y)\vert_{x^0 < y^0}
        & = \int \frac{\dd^3p}{(2\pi)^3} e^{\img \ve{p} \cdot (\ve{x} - \ve{y})} \frac{\img}{2\pi} \left[ (2\pi \img) \frac{-E_\ve{p} \gamma^0 - \ve{p} \cdot \bs{\gamma} + m}{-2E_\ve{p}} e^{\img E_\ve{p} (x^0 - y^0)} \right] \\
        & = \int \frac{\dd^3p}{(2\pi)^3 2E_\ve{p}} e^{\img p_\mu \cdot (x-y)^\mu} (-E_\ve{p} \gamma^0 + \ve{p} \cdot \bs{\gamma} + m) \\
        & = - \int \frac{\dd^3p}{(2\pi)^3 2E_\ve{p}} e^{\img p_\mu \cdot (x-y)^\mu} (\slashed{p} - m)
      \end{split}
    \end{equation*}
...
Note that $ \dpr(x - y) \in \C^{4 \times 4} $, with two Dirac indices: $ \dpr_{\alpha \beta}(x-y) \equiv \braket{0 | \tempord\{\Psi_{I,\alpha}(x) \bar{\Psi}_{I,\beta}(y)\} | 0} $. It is straightforward to see that the Feynman propagator in momentum space is:
\begin{equation}
  \dprp(x-y) = \frac{\img (\slashed{p} + m)}{p^2 - m^2 + \img \epsilon}
\end{equation}

\begin{lemma}[before upper = {\tcbtitle}]{Dirac propagator in momentum space}{}
  \begin{equation}
    \dprp(x-y) = \frac{\img}{\slashed{p} - m}
  \end{equation}
\end{lemma}
...
This is interpreted as the inverse matrix $ \img (\slashed{p} - m)^{-1} $.
As for the Feynman propagator, the Dirac propagator too is a Green function for the Dirac operator:
\begin{equation*}
  (\img \slashed{\pa}_x - m) \dpr(x-y) = \int \frac{\dd^4p}{(2\pi)^4} \frac{\img}{\slashed{p} - m} (\gamma^\mu p_\mu - m) e^{-\img p_\mu (x-y)^\mu} = \img \delta^{(4)}(x - y)
\end{equation*}
...
Note that only fully-contracted terms contribute to the $ n $-point Green function: every term with at least an uncontracted field vanishes when put between $ \braket{0| \cdot |0} $, as there will be an annihilation operator acting on $ \ket{0} $ or a creation operator acting on $ \bra{0} $.
...
\begin{example}{4-point Green function}{4-green-func}
  ...
  \begin{equation*}
    \begin{split}
      ...
      & = \fpr(x_1 - x_2) \fpr(x_3 - x_4) + \fpr(x_1 - x_3) \fpr(x_2 - x_4) + \\
      & \qquad \qquad \qquad \qquad \qquad \qquad \qquad + \fpr(x_1 - x_4) \fpr(x_2 - x_3)
    \end{split}
  \end{equation*}
  This expression has immediate physical interpretation: indeed, $ \fpr(x_1 - x_2) $ can be interpreted as the amplitude for the propagation of a particle from spacetime point $ x_1 $ to $ x_2 $, while $ \fpr(x_1 - x_2) \fpr(x_3 - x_4) $ is the amplitude for the propagation of a particle from $ x_1 $ to $ x_2 $ and one from $ x_3 $ to $ x_3 $, without interacting with each other. \\
  It is possible to associate intuitive graphs, called \bcex{Feynman diagrams}, to these kind of expressions; for example:
  \begin{equation*}
    \fpr(x_1 - x_2) \fpr(x_3 - x_4)
    =
...
\subsubsection{Scattering in \texorpdfstring{$ \lambda \phi^4 $}{λφ4}-theory}
\label{sssec:lamb-4}
...
\begin{equation*}
  \begin{split}
    \braket{\ve{p}_1 , \ve{p}_2 | \img T | \ve{k}_1 , \ve{k}_2} \hspace{-0.15em}
    & = \hspace{-0.06em} \frac{k_1^2 - m^2}{\img \sqrt{Z}} \frac{k_2^2 - m^2}{\img \sqrt{Z}} \frac{p_1^2 - m^2}{\img \sqrt{Z}} \frac{p_2^2 - m^2}{\img \sqrt{Z}} \int \prod_{i = 1}^4 \dd^4x_i\, e^{\img ({p_1}_\mu {x_1}^\mu + {p_2}_\mu {x_2}^\mu - {p_3}_\mu {x_3}^\mu - {p_4}_\mu {x_4}^\mu)} \times \\
    & \qquad \qquad \times \frac{\braket{0 | \tempord\{ \phi(x_1) \phi(x_2) \phi(x_3) \phi(x_4) \exp \left[ -\img \frac{\lambda}{4!} \int \dd^4x\, \phi(x) \right] \} | 0}}{\braket{0 | \tempord\{\exp \left[ - \img \frac{\lambda}{4!} \int \dd^4x\, \phi(x) \right]\} | 0}}
  \end{split}
\end{equation*}
...
\begin{equation*}
  \begin{split}
    & \int \dd^4x_1 \dd^4x_2 \dd^4x_3 \dd^4x_4\, e^{\img ({p_1}_\mu {x_1}^\mu + {p_2}_\mu {x_2}^\mu - {p_3}_\mu {x_3}^\mu - {p_4}_\mu {x_4}^\mu)} \braket{0 | \tempord\{\phi(x_1) \phi(x_2) \phi(x_3) \phi(x_4)\} | 0} \\
    & \quad = \int \dd^4x_1 \dd^4x_2 \dd^4x_3 \dd^4x_4\, e^{\img ({p_1}_\mu {x_1}^\mu + {p_2}_\mu {x_2}^\mu - {p_3}_\mu {x_3}^\mu - {p_4}_\mu {x_4}^\mu)} \left[ \fpr(x_1 - x_2) \fpr(x_3 - x_4) + \dots \right] \\
    & \quad = \hspace{-0.2em} \left[ \int \dd^4x \dd^4X\, e^{\img (p_1 + p_2)_\mu X^\mu + \img (p_1 - p_2)_\mu x^\mu/2} \fpr(x) \right] \hspace{-0.3em} \left[ \int \dd^4y \dd^4Y\, e^{- \img (k_1 + k_2)_\mu Y^\mu - \img (k_1 - k_2)_\mu y^\mu/2} \fpr(y) \right] \hspace{-0.1em} + \dots \\
    & \quad = (2\pi)^4 \delta^{(4)}(p_1 + p_2) \frac{\img}{\left( \frac{p_1 - p_2}{2} \right)^2 - m^2} (2\pi)^4 \delta^{(4)}(k_1 + k_2) \frac{\img}{\left( \frac{k_1 - k_2}{2} \right)^2 - m^2} + \dots
  \end{split}
\end{equation*}
with $ x = x_1 - x_2 , 2X = x_1 + x_2 $ and $ y = x_3 - x_4 , 2Y = x_3 + x_4 $. Then, using $ f(x) \delta(x - x_0) = f(x_0) \delta(x - x_0) $:
\begin{equation*}
  \begin{split}
    ...
    & \qquad \qquad \qquad \qquad \qquad \qquad \qquad = (2\pi)^4 \delta^{(4)}(p_1 + p_2) (2\pi)^4 \delta^{(4)}(k_1 + k_2) \frac{\img}{p_1^2 - m^2} \frac{\img}{k_1^2 - m^2} + \dots
  \end{split}
\end{equation*}
Note that the $ \img \epsilon $ term must be retained while $ p $ is an integration variable, as it gives the prescription of going around the poles, but it can be dropped when $ p $ is the momentum on an external leg, i.e. fixed. This expression only has two poles, therefore:
\begin{equation*}
  \braket{\ve{p}_1 , \ve{p}_2 | \img T | \ve{k}_1 , \ve{k}_2} = - (2\pi)^8 \delta^{(4)}(p_1 + p_2) \delta^{(4)}(k_1 + k_2) (p_2^2 - m^2) (k_2^2 - m^2) + \dots + o(\lambda)
\end{equation*}
...
\begin{equation*}
  \int \prod_{i = 1}^4 \dd^4x_i\, e^{\img ({p_1}_\mu {x_1}^\mu + {p_2}_\mu {x_2}^\mu - {p_3}_\mu {x_3}^\mu - {p_4}_\mu {x_4}^\mu)} \left( - \img \frac{\lambda}{4!} \right) \int \dd^4x \braket{0 | \tempord\{\phi(x_1) \phi(x_2) \phi(x_3) \phi(x_4) \phi^4(x)\} | 0}
\end{equation*}
...
\begin{equation*}
  \begin{split}
    & -\img \lambda \int \dd^4x \prod_{i = 1}^4 \dd^4x_i\, e^{\img ({p_1}_\mu {x_1}^\mu + {p_2}_\mu {x_2}^\mu - {p_3}_\mu {x_3}^\mu - {p_4}_\mu {x_4}^\mu)} \fpr(x_1 - x) \fpr(x_2 - x) \fpr(x_3 - x) \fpr(x_4 - x) \\
    & = -\img \lambda \fprp(p_1) \fprp(p_2) \fprp(k_1) \fprp(k_2) \int \dd^4x\, e^{\img (p_1 + p_2 - k_1 - k_2)_\mu x^\mu} \\
    & = -\img \lambda (2\pi)^4 \delta^{(4)}(p_1 + p_2 - k_1 - k_2) \frac{\img}{p_1^2 - m^2} \frac{\img}{p_2^2 - m^2} \frac{\img}{k_1^2 - m^2} \frac{\img}{k_2^2 - m^2}
  \end{split}
\end{equation*}
There remains to evaluate the denominator: this term gives only \bctxt{vacuum-to-vacuum transitions}, i.e. diagrams with no external legs. To account for these, note that each connected diagram which contributes to the numerator can be ``dressed" with all possible vacuum-to-vacuum transitions; indeed, to be precise:
\begin{equation*}
  \braket{0 | \wick{\c1\phi(x_1) \c2\phi(x_2) \c3\phi(x_3) \c4\phi(x_4) \c1\phi(x) \c2\phi(x) \c3\phi(x) \c4\phi(x)} | 0} =
\end{equation*}
\begin{equation*}
...
\begin{equation}
  \braket{\ve{p}_1 , \ve{p}_2 | \img T | \ve{k}_1 , \ve{k}_2} = -\img \lambda (2\pi)^4 \delta^{(4)}(p_1 + p_2 - k_1 - k_2)
\end{equation}
...
\begin{equation*}
  \sum (\text{diagrams}) \hspace{-0.08em} = \sum_{i \in \mathcal{I}} C_i \times \sum_{\{n_j\} \subset \N_0} \prod_{j \in \mathcal{J}} \frac{1}{n_j!} V_j^{n_j} = \sum_{i \in \mathcal{I}} C_i \times \prod_{j \in \mathcal{J}} \sum_{n = 1}^\infty \frac{1}{n!} V_j^n = \sum_{i \in \mathcal{I}} C_i \times \prod_{j \in \mathcal{J}} \exp V_j = \sum_{i \in \mathcal{I}} C_i \times \exp \sum_{j \in \mathcal{J}} V_j
\end{equation*}
which can be recast in the form:
\begin{equation}
  \sum (\text{diagrams}) = \sum (\text{connected}) \times \exp \sum (\text{vacuum-to-vacuum})
\end{equation}
The exponential exactly cancels $ \braket{0 | \tempord\{\exp \left[ -\img \int \dd^4x\, \ham_I \right]\} | 0} $, leaving only connected diagrams in the calculation.}

\subsubsection{Scattering in \texorpdfstring{$ \lambda \phi^3 $}{λφ3}-theory}
...
\begin{equation*}
  \begin{split}
    \braket{\ve{p}_1 , \ve{p}_2 | \img T | \ve{k}_1 , \ve{k}_2}
    & = \prod_{i = 1,2} \frac{p_i^2 - m^2}{\img \sqrt{Z}} \prod_{j = 1,2} \frac{k_j^2 - m^2}{\img \sqrt{Z}} \int \prod_{i = 1}^4 \dd^4x_i\, e^{\img ({p_1}_\mu x_1^\mu + {p_2}_\mu x_2^\mu - {k_1}_\mu x_3^\mu - {k_4}_\mu x_4^\mu)} \times \\
    & \qquad \qquad \qquad \qquad \times \braket{0 | \tempord\{\phi(x_1) \phi(x_2) \phi(x_3) \phi(x_4) \exp \left[ -\img \frac{\lambda}{3!} \int \dd^4x\, \phi^3(x) \right]\} | 0}
  \end{split}
\end{equation*}
...
\begin{equation*}
  \begin{split}
    \braket{\ve{p}_1 , \ve{p}_2 | \img T | \ve{k}_1 , \ve{k}_2}
    & = \frac{p_1^2 - m^2}{\img \sqrt{Z}} \frac{p_2^2 - m^2}{\img \sqrt{Z}} \frac{k_1^2 - m^2}{\img \sqrt{Z}} \frac{k_2^2 - m^2}{\img \sqrt{Z}} \int \prod_{i = 1}^4 \dd^4x_i\, e^{\img ({p_1}_\mu x_1^\mu + {p_2}_\mu x_2^\mu - {k_1}_\mu x_3^\mu - {k_4}_\mu x_4^\mu)} \times \\
    & \qquad \qquad \times \frac{1}{2!} \left( -\img \frac{\lambda}{3!} \right)^2 \int \dd^4x \dd^4y \braket{0 | \tempord\{\phi(x_1) \phi(x_2) \phi(x_3) \phi(x_4) \phi^3(x) \phi^3(y)\} | 0}
  \end{split}
\end{equation*}
...
\begin{equation*}
  ...
  \end{tikzpicture}
  \quad = \quad
  \fpr(x_1 - x) \fpr(x_2 - x) \fpr(x - y) \fpr(y - x_3) \fpr(y - x_4)
\end{equation*}
\begin{equation*}
  \begin{tikzpicture}[baseline=(r.base)]
    \begin{feynman}[inline=(r.base)]
  ...
  \end{tikzpicture}
  \quad = \quad
  \fpr(x_1 - y) \fpr(x_2 - x) \fpr(x - y) \fpr(y - x_3) \fpr(x - x_4)
\end{equation*}
These diagrams are inequivalent, as they correspond to different sets of contractions. Computing for example the first one:
\begin{equation*}
  \begin{split}
    & (-\img \lambda)^2 \int \prod_{i = 1}^4 \dd^4x_i\, e^{\img ({p_1}_\mu x_1^\mu + {p_2}_\mu x_2^\mu - {k_1}_\mu x_3^\mu - {k_4}_\mu x_4^\mu)} \times \\
    & \qquad \qquad \qquad \qquad \qquad \quad \times \int \dd^4x \dd^4y\, \fpr(x_1 - x) \fpr(x_2 - x) \fpr(x - y) \fpr(y - x_3) \fpr(y - x_4) \\
    & = (-\img \lambda)^2 \fprp(p_1) \fprp(p_2) \fprp(k_1) \fprp(k_2) \int \dd^4x \dd^4y\, e^{\img (p_1 + p_2)_\mu x^\mu - i (k_1 + k_2)_\mu y^\mu} \fpr(x - y) \\
    & = (-\img \lambda)^2 \fprp(p_1) \fprp(p_2) \fprp(k_1) \fprp(k_2) \int \dd^4X \dd^4Y\, e^{\img (p_1 + p_2 - k_1 - k_2)_\mu Y^\mu + \img (p_1 + p_2 + k_1 + k_2)_\mu X^\mu / 2} \fpr(X) \\
    & = (-\img \lambda)^2 (2\pi)^4 \delta^{(4)}(p_1 + p_2 - k_1 - k_2) \fprp(p_1) \fprp(p_2) \fpr(p_1 + p_2) \fprp(k_1) \fprp(k_2)
  \end{split}
\end{equation*}
with $ X = x - y , 2Y = x + y $. As expected, momentum-space propagators associated to external legs are canceled by pole terms in the LSZ formula: now there remains only the $ \fprp(p_1 + p_2) $ factor associated to the internal line. \\
...
\begin{enumerate}
  ...
  \item each external leg is associated to a pole factor in the LSZ reduction formula, hence they can be omitted directly (``leg amputation");
  \item as there is always a momentum-conserving $ \delta $-function, it is convenient to define the matrix element $ \mat $ for the process $ \ket{\text{in}} \rightarrow \ket{\text{out}} $ as:
    \begin{equation}
      \braket{\ve{p}_1 , \dots , \ve{p}_m | \img T | \ve{k}_1 , \dots , \ve{k}_n} \equiv (2\pi)^4 \delta^{(4)}\left( \sum_{i = 1}^{m} p_i - \sum_{j = 1}^{n} k_j \right) \img \mat
      \label{eq:mat-el}
    \end{equation}
  \item energy-momentum conservation must be imposed separately at each vertex;
  \item each vertex is associated to a $ -\img \lambda $ factor, where $ \lambda $ is the coupling constant of the interaction;
...
\begin{multline*}
  \frac{1}{2!} \left( -\img \frac{\lambda}{4!} \right)^2 \int \prod_{i = 1}^4 \dd^4x_i\, e^{\img ({p_1}_\mu x_1^\mu + {p_2}_\mu x_2^\mu - {k_1}_\mu x_3^\mu - {k_4}_\mu x_4^\mu)} \times \\
...
\begin{equation*}
  \begin{split}
    & \hspace{-0.2em} \frac{(-\img \lambda)^2}{2} \int \prod_{i = 1}^4 \dd^4x_i\, e^{\img ({p_1}_\mu x_1^\mu + {p_2}_\mu x_2^\mu - {k_1}_\mu x_3^\mu - {k_4}_\mu x_4^\mu)} \int \dd^4x \dd^4y\, \fpr(x_1 - x) \fpr(x_2 - x) \fpr(x - y) \fpr(y - x) \\
    & = \frac{(-\img \lambda)^2}{2} \fprp(p_1) \fprp(p_2) \fprp(k_1) \fprp(k_2) \int \dd^4x \dd^4y\, e^{\img (p_1 + p_2)_\mu x^\mu - \img (k_1 + k_2)_\mu y^\mu} \fpr^2(x - y) \\
    & = \frac{(-\img \lambda)^2}{2} \fprp(p_1) \fprp(p_2) \fprp(k_1) \fprp(k_2) (2\pi)^4 \delta^{(4)}(p_1 + p_2 - k_1 - k_2) \int \frac{\dd^4k}{(2\pi)^4} \fprp(k) \fprp(p_1 + p_2 - k)
  \end{split}
\end{equation*}
...
\begin{equation}
  \ampl(p) \defeq \frac{(-\img \lambda)^2}{2} \int \frac{\dd^4k}{(2\pi)^4} \frac{\img}{k^2 - m^2 + \img \epsilon} \frac{\img}{(p - k)^2 - m^2 + \img \epsilon}
  \label{eq:f4-loop-ampl}
\end{equation}
so that the $ 2 \rightarrow 2 $ scattering amplitude at one-loop level (i.e. $ o(\lambda^2) $) is:
\begin{equation}
  \img \mat_{2 \rightarrow 2} = -\img \lambda + \ampl(p_1 + p_2) + \ampl(p_1 - k_1) + \ampl(p_1 - k_2)
\end{equation}

\subsubsection{Divergences}
\label{sssec:div}

The integral in \eref{eq:f4-loop-ampl} diverges at large $ k $, which is an example of \bctxt{UV divergence}. To study this divergence, first of all note that $ (p - k)^2 \rightarrow k^2 $ as $ k \rightarrow \infty $, so that it is safe to set $ p = 0 $. Due to the $ \img \epsilon $-presciption, in the complex $ k^0 $-plane the pole in $ k^0 > 0 $ is below the real axis, while that in $ k^0 < 0 $ is above it: the integration path can then be rotated counterclockwise from the real axis to the imaginary axis by $ k^0 \mapsto \img k^0 $, which is called a \bctxt{Wick rotation}. The amplitude then becomes:
\begin{equation*}
    \ampl(0) = \frac{(-\img \lambda)^2}{2} \int \frac{\dd^4k}{(2\pi)^4} \left( \frac{\img}{k^2 - m^2 + \img \epsilon} \right)^2 \mapsto \img \frac{\lambda^2}{2} \int \frac{\dd^4k}{(2\pi)^4} \frac{1}{(k^2 + m^2)^2}
\end{equation*}
...
\begin{equation*}
  \begin{split}
    \ampl(0)
    & = \img \frac{\lambda^2}{2} \int \frac{\dd^4k}{(2\pi)^4} \frac{1}{k^4} + \text{finite terms} = \img \frac{\lambda^2}{2} \frac{1}{(2\pi)^4} 2\pi^2 \int^\Lambda \frac{\dd k}{k} + \text{finite terms}\\
    & = \frac{\img \lambda^2}{16 \pi^2} \log \Lambda + \text{finite terms}
  \end{split}
\end{equation*}
where $ 2\pi^2 $ is the solid angle in $ \R^4 $. It can be shown that, for general $ p $, the singular part of $ \ampl(p) $ does not depend on $ p $; hence, it can be written:
\begin{equation*}
  \img \mat_{2 \rightarrow 2} = -\img \lambda + \img \lambda^2 \left( \beta_0 \log \Lambda + \text{finite terms} \right)
\end{equation*}
where:
\begin{equation}
...
\begin{equation*}
  \braket{0 | \tempord\{\phi(x_1) \phi(x_2) \phi^4(x)\} | 0} = 4\cdot3 \cdot \wick{\c1\phi(x_1) \c2\phi(x_2) \c1\phi(x) \c2\phi(x) \c1\phi(x) \c1\phi(x)} = 4 \cdot 3 \times
  \begin{tikzpicture}[baseline = (r.base)]
    \begin{feynman}[inline = (r.base)]
      \vertex (x1) {};
      \vertex[right=5em of x1, dot] (v1) {};
      \vertex[above=3em of v1] (v2);
...
\begin{equation}
  -\img B \equiv \frac{-\img \lambda}{2} \int \frac{\dd^4k}{(2\pi)^4} \frac{1}{k^2 + m^2} = - \img \frac{\lambda}{32\pi^2} \left( \Lambda^2 - m^2 \log \frac{\Lambda^2 + m^2}{m^2} \right)
\end{equation}
Note that the tadpole is independent of $ p $, and it has both a quadratic and logarithmic UV divergence.

\begin{lemma}{Tadpole resummation}{tadpole-resumm}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        & \fprp(p) + \fprp(p) (-\img B) \fprp(p) + \fprp(p) (-\img B) \fprp(p) (-\img B) \fprp(p) + \dots \\
        & \quad = \fprp(p) \sum_{n = 0}^{\infty} \left[ -\img B \fprp(p) \right]^n = \fprp \frac{1}{1 + \img B \fprp(p)} = \frac{\img}{p^2 - m^2} \left[ 1 - \frac{B}{p^2 - m^2} \right]^{-1} = \frac{\img}{p^2 - m^2 - B}
      \end{split}
    \end{equation*}
    which is the thesis.
  \end{proof}
...
To compute amplitudes up to a desired order, it is not necessary to explicitly expand the exponential each time and then perform Wick contractions, as these steps are summarized by a simple set of rules.
  ...
  \item propagators:
    \begin{enumerate}
      ...
      \begin{tikzpicture}[baseline = (r.base)]
        ...
        \end{feynman}
      \end{tikzpicture}
      \,=\, \displaystyle\frac{\img}{q^2 - m_\phi^2 + \img \epsilon} = \fprp(q)
      $;
      \item fermion:
      $
      \begin{tikzpicture}[baseline = (r.base)]
        ...
        \end{feynman}
      \end{tikzpicture}
      \,=\, \displaystyle\frac{\img (\slashed{p} + m)}{p^2 - m^2 + \img \epsilon} = \dprp(p)
      $;
    \end{enumerate}
  \item vertex:
    $
...
The photon propagator is derived in \secref{ssec:qed-path}:
\begin{equation}
  \gpr_{\mu \nu}(x-y) \defeq \braket{0 | \tempord\{A_\mu(x) A_\nu(y)\} | 0}
  \quad \implies \quad
  \gprp_{\mu \nu}(k) = \frac{-\img}{k^2 + \img \epsilon} \eta_{\mu \nu}
  \label{eq:phot-prop}
\end{equation}
