...
\begin{equation}
  \mt{U}(y,x) \mapsto e^{i \alpha(y)} \mt{U}(y,x) e^{-i \alpha(x)}
...
\begin{equation}
  \mt{U}(x + \varepsilon n, x) = \mt{I}_n + i g \varepsilon n^\mu \con_\mu^a(x) T_a + o(\varepsilon^2)
...
\begin{equation}
  D_\mu = \pa_\mu - i g \con_\mu^a T_a
\end{equation}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        \mt{I}_n + i g \varepsilon n^\mu \con_\mu^a T_a
        & \mapsto V(x + \varepsilon n) \left( \mt{I}_n + i g \varepsilon n^\mu \con_\mu^a T_a \right) V\dg(x) \\
        & = \left[ \left( 1 + \varepsilon n^\mu \pa_\mu \right) V(x) \right] V\dg(x) + V(x) \left( i g \varepsilon n^\mu \con_\mu^a T_a \right) V\dg(x) + o(\varepsilon^2) \\
        & = \mt{I}_n - \varepsilon n^\mu V(x) \pa_\mu V\dg(x) + V(x) \left( i g \varepsilon n^\mu \con_\mu^a T_a \right) V\dg(x) + o(\varepsilon^2)
      \end{split}
    \end{equation*}
    Hence, the connection transforms as:
    \begin{equation*}
      \con_\mu^a(x) T_a \mapsto V(x) \left[ \con_\mu^a(x) T_a + \frac{i}{g} \pa_\mu \right] V\dg(x)
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        \con_\mu^a(x) T_a
        & \mapsto \left( \mt{I}_n + i \theta^b(x) T_b + o(\theta^2) \right) \left[ \con_\mu^a(x) T_a + \frac{i}{g} \pa_\mu \right] \left( \mt{I}_n - i \theta^c(x) T_c + o(\alpha^2) \right) \\
        & = \left( \mt{I}_n + i \theta^b(x) T_b + o(\theta^2) \right) \left[ \con_\mu^a(x) T_a - i \con_\mu^a(x) \theta^c(x) T_a T_c + \frac{1}{g} \pa_\mu \theta^c(x) T_c + o(\theta^2) \right] \\
        & = \con_\mu^a(x) T_a - i \con_\mu^a(x) \theta^c(x) T_a T_c + i \theta^b(x) \con_\mu^a(x) T_b T_a + \frac{1}{g} \pa_\mu \theta^c(x) T_c + o(\theta^2) \\
    ...
    \begin{equation*}
      \begin{split}
        D_\mu \Psi(x)
        & \hspace{-0.1em} \mapsto \hspace{-0.2em} \left[ \pa_\mu \hspace{-0.1em} - i g \con_\mu^a(x) T_a - i g f^{abc} \con_\mu^a(x) \theta^b(x) T_c - i \pa_\mu \theta^a(x) T_a \right] \hspace{-0.1em} \left( \mt{I}_n + i \theta^a(x) T_a \right) \Psi(x) + o(\theta^2) \\
        & \hspace{-1.5em} = \hspace{-0.05em} \left[ \pa_\mu \hspace{-0.1em} + i \theta^a T_a \pa_\mu + i \pa_\mu \theta^a T_a - i g \con_\mu^a T_a + g \con_\mu^a \theta^b T_a T_b - i g f^{abc} \con_\mu^a \theta^b T_c - i \pa_\mu \theta^a T_a + o(\theta^2) \right] \Psi \\
        & \hspace{-1.5em} = \hspace{-0.05em} \left[ \pa_\mu \hspace{-0.1em} + i \theta^a T_a \pa_\mu - i g \con_\mu^a T_a + g \con_\mu^a \theta^b T_a T_b - i g f^{abc} \con_\mu^a \theta^b T_c + o(\theta^2) \right] \Psi
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        D_\mu \Psi(x)
        & \mapsto \left[ \pa_\mu + i \theta^a(x) T_a \pa_\mu - i g \con_\mu^a(x) T_a + g \theta^b(x) T_b \con_\mu^a(x) T_a + o(\theta^2) \right] \Psi(x) \\
        & = \left[ \mt{I}_n + i \theta^a(x) T_a + o(\theta^2) \right] \left( \pa_\mu - i g \con_\mu^a(x) T_a \right) \Psi(x) = V(x) D_\mu \Psi(x)
      \end{split}
    \end{equation*}
    which is the thesis.
  \end{proof}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        [D_\mu , D_\nu]
        & = [\pa_\mu , \pa_\nu] - i g [\con_\mu^a , \pa_\nu] T_a - i g [\pa_\mu , \con_\nu^a] T_a - g^2 \con_\mu^b \con_\nu^c [T_b , T_c] \\
        & = - i g \left( \con_\mu^a \pa_\nu - \pa_\nu \con_\mu^a - \con_\mu^a \pa_\nu \right) T_a - i g \left( \con_\nu^a \pa_\mu - \pa_\mu \con_\nu^a - \con_\nu^a \pa_\mu \right) T_a - i g^2 f^{bca} \con_\mu^b \con_\nu^b T_c \\
        & = - i g \left( \pa_\mu \con_\nu^a - \pa_\nu \con_\mu^a + g f^{bca} \con_\mu^b \con_\mu^c \right) T_a
      \end{split}
    \end{equation*}
