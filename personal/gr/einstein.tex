...
\begin{proposition}{Stationary metric}{}
...
In a static spacetime, the flow of $ K $ isometrically maps spacelike sections $ \{t = \text{const.}\} $ onto each other, and an observer at rest moves along integral curves of $ K $.

\subsection{Motion in a Schwarzschild field}

\subsection{Classical test of General Relativity}
