...
\begin{proposition}{Lensed image}{}
  The imaged produced by the lens has dimension:
  \begin{equation}
...
\begin{equation}
  A = \frac{r'^2 + 2 b_\text{E}^2}{r' \sqrt{r'^2 + 4 b_\text{E}^2}}
\end{equation}
