...
\end{equation}
where $ w_a $ characterizes the component. This equation can be integrated, obtaining the time-dependence of the scale factor:
\begin{equation}
  a(t) \propto
  \begin{cases}
