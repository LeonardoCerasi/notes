...
\end{equation*}
In particular, matter splits into $ 5\% $ baryonic matter, i.e. with $ \Omega_\text{b} \simeq 0.05 $, and $ 27\% $ cold dark matter, i.e. with $ \Omega_\text{DM} \simeq 0.27 $. Moreover, note that even today curvature only contribute for less than $ 1\% $ of cosmic energy, and, since $ \Omega_k \propto a^{-2} $ while $ \Omega_\text{m} \propto a^{-3} $ and $ \Omega_\text{r} \propto a^{-4} $, in the past it was completely negligible: hence, setting $ \Omega_k \equiv 0 $ is justified, i.e. $ k \equiv 0 $.
