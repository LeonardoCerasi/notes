...
The force of gravity is mediated by a gravitational field, which is identified with a metric $ g(x) $ on a $ n $-dimensional Lorentzian manifold called \emph{spacetime}. This metric is a dynamical object, as all other fields in Nature, thus the laws governing its dynamics must be studied.
...
Spacetime is a Lorentzian $ n $-manifold $ \mathcal{M} $, thus, recalling the canonical volume form in \eref{eq:volume-form}, there needs to be a metric-dependent scalar function on $ \mathcal{M} $: the obvious non-trivial choice is the Ricci scalar. The resulting action is the \bctxt{Einstein--Hilbert action}:
\begin{equation}
  \act = \int \dd^n x \sqg \, R
...
Schematically, the Riemann tensor is $ R \sim \pa \Gamma + \Gamma \Gamma $, while $ \Gamma \sim \pa g $, thus the Einstein--Hilbert Lagrangian is second order in derivatives of the metric, like most other Lagrangians of bosonic fields in physics.
...
\begin{observation}{Dimensionale analysis}{}
  ...
  In a $ 4 $-dimensional spacetime, if $ x^\mu $ has dimension of length, then $ g_{\mu \nu} $ is dimensionless and the Ricci scalar is $ [R] = L^{-2} $. Including the integration measure, $ [\act] = L^2 $, but it must have the same dimension of $ [\hbar] =  M L^2 T^{-1} $ (i.e. energy $ \times $ time). Thus, the action with the right dimension is:
  \begin{equation}
    \act = \frac{c^3}{16 \pi G} \int \dd^4 x \sqg \, R
...
\begin{proofbox}
  \begin{proof}
    ...
    In normal coordinates, the Riemann tensor becomes $ \tensor{R}{^\sigma_{\mu \rho \nu}} \vert_p = \pa_\rho \Gamma^\sigma_{\nu \mu} \vert_p - \pa_\nu \Gamma^\sigma_{\rho \mu} \vert_p $, so:
    \begin{equation*}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \delta \act = \delta \int \dd^n x \sqg\, g^{\mu \nu} R_{\mu \nu} = \int \dd^n x \left[ (\delta \sqg) g^{\mu \nu} R_{\mu \nu} + \sqg (\delta g^{\mu \nu}) R_{\mu \nu} + \sqg\, g^{\mu \nu} (\delta R_{\mu \nu}) \right] \\
    \end{equation*}
    Inserting the expressions in \lref{lemma:metric-variations}:
    \begin{equation*}
      \delta \act = \int \dd^n x \sqg \left[ \left( - \frac{1}{2} R g_{\mu \nu} + R_{\mu \nu} \right) \delta g^{\mu \nu} + g^{\mu \nu} \left( \na_\rho \delta \Gamma^\rho_{\mu \nu} - \na_\nu \Gamma^\rho_{\rho \mu} \right) \right]
    \end{equation*}
    Then, using the metric compatibility of the Levi--Civita connection:
    \begin{equation*}
      \act = \int \dd^n x \sqg \left[ \left( R_{\mu \nu} - \frac{1}{2} R g_{\mu \nu} \right) \delta g^{\mu \nu} + \na_\mu \left( g^{\rho \nu} \delta \Gamma^\mu_{\rho \nu} - g^{\mu \nu} \delta \Gamma^\rho_{\rho \nu} \right) \right]
    \end{equation*}
    The last term is a total derivative, hence by the divergence theorem \eref{eq:gauss-theorem} it yields a boundary term which can be ignored (the so-called \emph{Gibbons--Hawking--York boundary term}). The Euler--Lagrange equations are then found imposing $ \delta \act = 0 $ for arbitrary $ \delta g_{\mu \nu} $, so recalling the definition of the Einstein tensor \eref{eq:einstein-def} the proof is completed.
  \end{proof}
\end{proofbox}
...
\begin{equation}
  \mathcal{S} = \frac{1}{16 \pi G} \int \dd^n x \sqg \left[ R - (n - 2) \Lambda \right]
\end{equation}
$ \Lambda \in \R $ is known as a \emph{cosmological constant} and has dimension $ [\Lambda] = L^{-2} $. The resulting field equations are:
\begin{equation}
  R_{\mu \nu} - \frac{1}{2} R g_{\mu \nu} = - \frac{n-2}{2} \Lambda g_{\mu \nu}
\end{equation}
Contracting with $ g^{\mu \nu} $ yields $ R = \frac{2n}{n-2} \Lambda $, thus in the absence of matter:
\begin{equation}
  R_{\mu \nu} = \Lambda g_{\mu \nu}
\end{equation}
Manifolds on which $ \ricc = \kappa g $ for a constant $ \kappa \in \R $ are known as \bctxt{Einstein manifolds}: clearly, Ricci-flat manifolds are a special class of Einstein manifolds with $ \kappa = 0 $. Notice that Einstein manifolds have constant Ricci scalar curvature $ R = n \kappa $.
...
\begin{lemma}{Transformation of tensors under infinitesimal diffeomorphisms}{tens-inf-diff}
  ...
  \begin{equation}
    \tensor{\delta T}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x) \defeq \tensor{\tilde{T}}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x) - \tensor{T}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x)
  \end{equation}
  Then, if $ \tilde{x}^\mu(x) = x^\mu - Z^\mu(x) $, the pointwise variation of $ T $ is:
  \begin{equation}
     \tensor{\delta T}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x) = \tensor{(\ld_Z T)}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x) + \smo(Z^2)
  \end{equation}
\end{lemma}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \begin{split}
        \tensor{\tilde{T}}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(\tilde{x})
        & = \tensor{T}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x) - \sum_{i = 1}^r \tensor{T}{^{\mu_1 \dots \rho \dots \mu_r}_{\nu_1 \dots \nu_l}}(x) \pa_\rho Z^{\mu_i}(x) \\
        & \qquad \qquad \qquad \qquad \qquad \qquad + \sum_{j = 1}^s \tensor{T}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \rho \dots \nu_s}}(x) \pa_{\nu_j} Z^\rho(x) + \smo(Z^2)
      \end{split}
    \end{equation*}
    On the other hand:
    \begin{equation*}
      \begin{split}
        \tensor{\tilde{T}}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(\tilde{x})
        & = \tensor{\tilde{T}}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x) - Z^\rho \pa_\rho \tensor{\tilde{T}}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x)  \\
        & = \tensor{\tilde{T}}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x) - Z^\rho \pa_\rho \tensor{T}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x) + \smo(Z^2)
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        \tensor{\delta T}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x)
        & = Z^\rho \pa_\rho \tensor{T}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \nu_s}}(x) - \sum_{i = 1}^r \tensor{T}{^{\mu_1 \dots \rho \dots \mu_r}_{\nu_1 \dots \nu_l}}(x) \pa_\rho Z^{\mu_i}(x) \\
        & \qquad \qquad \qquad \qquad \qquad \qquad \qquad + \sum_{j = 1}^s \tensor{T}{^{\mu_1 \dots \mu_r}_{\nu_1 \dots \rho \dots \nu_s}}(x) \pa_{\nu_j} Z^\rho(x) + \smo(Z^2)
      \end{split}
    \end{equation*}
...
\begin{equation*}
  \delta \mathcal{S} = \int \dd^4 x \sqg\, G^{\mu \nu} \delta g_{\mu \nu} = 2 \int \dd^4 x \sqg\, G^{\mu \nu} \na_\mu Z_\nu
\end{equation*}
Invariance for $ x^\mu \mapsto x^\mu - Z^\mu $ means that $ \delta \mathcal{S} = 0 $ for all $ Z \in \xm $, hence, integrating by parts:
\begin{equation}
  \na_\mu G^{\mu \nu} = 0
  \label{eq:bianchi-id}
\end{equation}
...
By \eeref{eq:lie-der-metric}{eq:metric-variation}, this condition is equivalent to $ \ld_K g = 0 $, which means that the metric does not change along flow lines: this is called \textit{Killing equation}, and a vector field which satisfied it is a \bctxt{Killing vector field}.
Killing vectors are easily checked to form a Lie algebra: this is the Lie algebra of the isometry group of the manifold.

Given a Killing vector field $ K \in \xm $, it is always possible to find a set of coordinates $ (x^0 , x^1 , x^2 , y) $ on $ \man $ such that $ K = \frac{\pa}{\pa y} $, known as \emph{adapted coordinates}, in which the Killing equation simply reads:
\begin{equation*}
  \frac{\pa}{\pa y} g_{\mu \nu} = 0
\end{equation*}

\begin{example}{Ignorable degrees of freedom}{}
  Given a metric $ g_{\mu \nu}(x) $, if it does not depend on $ x^1 \equiv y $, then $ X = \pa_y $ is a Killing vector field, for $ (\ld_{\pa_y} g)_{\mu \nu} = \pa_y g_{\mu \nu} = 0 $. This is the case of ignorable degrees of freedom, as \eeref{eq:dS-energy}{eq:dS-ang-mom}.
\end{example}
...
\begin{theorem}{Noether's theorem}{}
  Let $ (\man,g) $ be a Lorentzian manifold, and suppose that it admits a Killing vector field $ K \in \xm $. Then, given an affinely-parametrized geodesic with tangent vector field $ U $, it is possible to define a \bcth{Noether charge} associated to $ K $ as:
  \begin{equation}
    Q_K \defeq \braket{U , K}_g
  \end{equation}
...
\begin{lemma}{Killing vectors and Riemann tensor}{}
  A Killing vector field $ K \in \xm $ satisfies:
  \begin{equation}
    \na_\nu \na_\alpha K_\mu = - \tensor{R}{_{\alpha \mu \nu}^\beta} K_\beta
...
\begin{proofbox}
  \begin{proof}
    By the Ricci identity \eref{eq:ricci-id}, assuming a torsionless-connection:
    \begin{equation*}
      \na_\mu \na_\nu K_\alpha - \na_\nu \na_\mu K_\alpha = \tensor{R}{_{\alpha \beta \mu \nu}} K^\beta = \tensor{R}{_{\mu \nu \alpha}^\beta} K_\beta
    \end{equation*}
    where the first symmetry of \eref{eq:riemann-symm} has been used. By the Killing equation $ \na_\nu \na_\mu K_\alpha = - \na_\nu \na_\alpha K_\mu $, so:
    \begin{equation*}
      \na_\mu \na_\nu K_\alpha + \na_\nu \na_\alpha K_\mu = \tensor{R}{_{\mu \nu \alpha}^\beta} K_\beta
    \end{equation*}
    ...
    \end{equation*}
    \begin{equation*}
      \na_\alpha \na_\mu K_\nu + \na_\mu \na_\nu K_\alpha = \tensor{R}{_{\alpha \mu \nu}^\beta} K_\beta
    \end{equation*}
    Summing the first two and subtracting the last one:
    \begin{equation*}
      2 \na_\nu \na_\alpha K_\mu = (\tensor{R}{_{\mu \nu \alpha}^\beta} + \tensor{R}{_{\nu \alpha \mu}^\beta} - \tensor{R}{_{\alpha \mu \nu}^\beta}) K_\beta
    \end{equation*}
    The Bianchi identity $ \tensor{R}{_{[\mu \nu \alpha]}^\beta} = 0 \implies \tensor{R}{_{\mu \nu \alpha}^\beta} + \tensor{R}{_{\nu \alpha \mu}^\beta} = - \tensor{R}{_{\alpha \mu \nu}^\beta} $ completes the proof.
  \end{proof}
\end{proofbox}

\ceref{eq:killing}{eq:killing-riemann} can be used to determine Killing vector fields: starting from a point $ p \in \man $ and moving along a curve, initial conditions are imposed on $ K^\mu \vert_p $ and $ \na_\mu K_\nu \vert_p $, however the Killing equation reduces the number of independent initial conditions, since only those on $ \na_{[\mu} K_{\nu]} \vert_p $ are relevant. On an $ n $-dimensional Lorentzian manifold $ \man $, then, the maximum number of independent Killing vector fields (i.e. of independent initial conditions) is:
\begin{equation}
  N_{K,\text{max}} = n + \frac{n (n-1)}{2} = \frac{n (n+1)}{2}
\end{equation}
A spacetime which admits $ N_{K,\text{max}} $ Killing vector fields is said to be \bctxt{maximally symmetric}. These $ N_{K,\text{max}} $ Killing vector fields split between generators of translations and rotations: indeed, in an $ n $-dimensional space there are $ n $ axes along which to define translations and $ \frac{1}{2} n (n-1) $ planes in which to define rotations, thus reproducing the above split between initial conditions.
...
\begin{definition}{Komar form}{}
  Given a Killing vector $ K = K^\mu \pa_\mu $ and the 1-form $ K^\flat \equiv K_\mu \dd x^\mu $, the associated \bcdef{Komar form} is the 2-form defined as:
  \begin{equation}
    F \defeq \dd K^\flat
  \end{equation}
\end{definition}
...
\begin{definition}{Komar integral}{}
  ...
  \begin{equation}
    Q_{\text{Komar}} \defeq - \frac{1}{8\pi G} \int_\Sigma \dd \star F = - \frac{1}{8\pi G} \int_{\pa \Sigma} \star\, F = - \frac{1}{8\pi G} \int_{\pa \Sigma} \star\, \dd K^\flat
  \end{equation}
\end{definition}
...
% TODO modify notation, overlap with Ricci scalar
...
\begin{equation*}
  \mathcal{S}_{\text{scalar}} = \int \dd^4 x \sqg \left[ - \frac{1}{2} g^{\mu \nu} \na_\mu \phi \na_\nu \phi - V(\phi) \right]
\end{equation*}
...
\begin{equation}
  \mathcal{S} = \frac{1}{16\pi G} \int \dd^4 x \sqg \left( R - 2 \Lambda \right) + \mathcal{S}_M
...
\begin{definition}{Energy-momentum tensor}{energy-momentum-tensor}
  ...
  \begin{equation}
    T_{\mu \nu} \defeq - \frac{2}{\sqg} \frac{\delta \mathcal{S}_M}{\delta g^{\mu \nu}}
...
\begin{proofbox}
  \begin{proof}
    ...
    \begin{equation*}
      \delta \mathcal{S} = \frac{1}{16\pi G} \int \dd^4 x \sqg \left[ G_{\mu \nu} + \Lambda g_{\mu \nu} \right] \delta g^{\mu \nu} - \frac{1}{2} \int \dd^4 x \sqg T_{\mu \nu} \delta g^{\mu \nu} = 0
    \end{equation*}
    which is the thesis.
  \end{proof}
\end{proofbox}
...
\begin{equation*}
  \delta \mathcal{S}_M = - \frac{1}{2} \int \dd^4 x \sqg \, T_{\mu \nu} \delta g^{\mu \nu} = - \int \dd^4 x \sqg \, T_{\mu \nu} \na^\mu X^\nu
\end{equation*}
