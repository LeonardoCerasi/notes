...
\begin{definition}{Komar form}{}
  ...
  \begin{equation}
    \ve{K}[\xi] \defeq (-1)^{d-1} \frac{1}{16 \pi \gd} \star \dd \xi^\flat
  \end{equation}
\end{definition}
...
\begin{equation}
  Q_\text{K}[\xi] \equiv \int_{\Sn{d-2}_\infty} \ve{K}[\xi] = (-1)^{d-1} \frac{1}{16 \pi \gd} \int_{\Sn{d-2}_\infty} \star \dd \xi^\flat
\end{equation}
