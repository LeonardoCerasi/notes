...
\usepackage[paperheight = 12.81cm, paperwidth = 27.13cm, top = 0em, bottom = 0em, left = 0em, right = 0em]{geometry}
...
\begin{tikzpicture}
  ...
  \node at (- 0.4 , \yscale * 0.2 - \offset) {\Large $ k_\text{e}^{-1} $};
  \node at (- 0.55 , \yscale * 0.5 - \offset) {\Large $ k_\text{BBN}^{-1} $};
  \node at (- 0.4 , \yscale * 0.8 - \offset) {\Large $ k_\text{eq}^{-1} $};
  \node at (- 0.4 , \yscale * 0.90 - \offset) {\Large $ k_\text{rec}^{-1} $};
  \node at (- 0.4 , \yscale * 0.97 - \offset) {\Large $ k_0^{-1} $};
  \node at (- 0.4 , \yscale * 1.1 - \offset) {\Large $ k_\Lambda^{-1} $};
